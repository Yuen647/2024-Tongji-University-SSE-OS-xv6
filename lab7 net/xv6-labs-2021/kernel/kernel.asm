...
0000000080000000 <_entry>:
    ...
    80000016:	706060ef          	jal	ra,8000671c <start>
...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    8000005e:	0bc080e7          	jalr	188(ra) # 80007116 <acquire>
  ...
  release(&kmem.lock);
    ...
    80000072:	15c080e7          	jalr	348(ra) # 800071ca <release>
}
    ...
    8000008e:	b42080e7          	jalr	-1214(ra) # 80006bcc <panic>
...
00000000800000dc <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f8:	f92080e7          	jalr	-110(ra) # 80007086 <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000130:	fea080e7          	jalr	-22(ra) # 80007116 <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000148:	086080e7          	jalr	134(ra) # 800071ca <release>
  ...
  release(&kmem.lock);
    ...
    80000172:	05c080e7          	jalr	92(ra) # 800071ca <release>
  if(r)
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000348:	ee4080e7          	jalr	-284(ra) # 80007228 <lockfree_read4>
    ...
    80000368:	8b2080e7          	jalr	-1870(ra) # 80006c16 <printf>
  ...
  scheduler();        
    ...
    80000430:	1f0080e7          	jalr	496(ra) # 8000661c <pci_init>
    sockinit();
    80000434:	00006097          	auipc	ra,0x6
    80000438:	dde080e7          	jalr	-546(ra) # 80006212 <sockinit>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    800004aa:	726080e7          	jalr	1830(ra) # 80006bcc <panic>
...
0000000080000600 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000062c:	5a4080e7          	jalr	1444(ra) # 80006bcc <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    800008ca:	306080e7          	jalr	774(ra) # 80006bcc <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    80000a0c:	1c4080e7          	jalr	452(ra) # 80006bcc <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b62:	06e080e7          	jalr	110(ra) # 80006bcc <panic>
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000dc2:	e0e080e7          	jalr	-498(ra) # 80006bcc <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000dee:	29c080e7          	jalr	668(ra) # 80007086 <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000e06:	284080e7          	jalr	644(ra) # 80007086 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000e3c:	24e080e7          	jalr	590(ra) # 80007086 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000eae:	220080e7          	jalr	544(ra) # 800070ca <push_off>
  ...
  pop_off();
    ...
    80000ec8:	2a6080e7          	jalr	678(ra) # 8000716a <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000eec:	2e2080e7          	jalr	738(ra) # 800071ca <release>

  if (first) {
    80000ef0:	00009797          	auipc	a5,0x9
    80000ef4:	9a07a783          	lw	a5,-1632(a5) # 80009890 <first.1722>
  ...
  usertrapret();
    ...
    80000f0e:	9807a323          	sw	zero,-1658(a5) # 80009890 <first.1722>
    fsinit(ROOTDEV);
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000f38:	1e2080e7          	jalr	482(ra) # 80007116 <acquire>
  pid = nextpid;
    80000f3c:	00009797          	auipc	a5,0x9
    80000f40:	95878793          	addi	a5,a5,-1704 # 80009894 <nextpid>
  ...
  release(&pid_lock);
    ...
    80000f52:	27c080e7          	jalr	636(ra) # 800071ca <release>
}
...
00000000800010aa <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800010cc:	04e080e7          	jalr	78(ra) # 80007116 <acquire>
    if(p->state == UNUSED) {
    ...
    800010da:	0f4080e7          	jalr	244(ra) # 800071ca <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    80001158:	076080e7          	jalr	118(ra) # 800071ca <release>
    return 0;
    ...
    80001170:	05e080e7          	jalr	94(ra) # 800071ca <release>
    return 0;
...
0000000080001178 <userinit>:
{
  ...
  uvminit(p->pagetable, initcode, sizeof(initcode));
    ...
    8000119c:	71858593          	addi	a1,a1,1816 # 800098b0 <initcode>
  ...
  release(&p->lock);
    ...
    800011ec:	fe2080e7          	jalr	-30(ra) # 800071ca <release>
}
...
000000008000126e <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001304:	eca080e7          	jalr	-310(ra) # 800071ca <release>
    return -1;
  ...
  release(&np->lock);
    ...
    80001356:	e78080e7          	jalr	-392(ra) # 800071ca <release>
  acquire(&wait_lock);
    ...
    80001368:	db2080e7          	jalr	-590(ra) # 80007116 <acquire>
  np->parent = p;
    8000136c:	0329bc23          	sd	s2,56(s3)
  release(&wait_lock);
    80001370:	8526                	mv	a0,s1
    80001372:	00006097          	auipc	ra,0x6
    80001376:	e58080e7          	jalr	-424(ra) # 800071ca <release>
  acquire(&np->lock);
    8000137a:	854e                	mv	a0,s3
    8000137c:	00006097          	auipc	ra,0x6
    80001380:	d9a080e7          	jalr	-614(ra) # 80007116 <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001390:	e3e080e7          	jalr	-450(ra) # 800071ca <release>
}
...
00000000800013aa <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000142c:	da2080e7          	jalr	-606(ra) # 800071ca <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000143e:	cdc080e7          	jalr	-804(ra) # 80007116 <acquire>
      if(p->state == RUNNABLE) {
...
000000008000144a <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    80001466:	c3a080e7          	jalr	-966(ra) # 8000709c <holding>
...
0000000080001520 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    80001538:	be2080e7          	jalr	-1054(ra) # 80007116 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    8000154e:	c80080e7          	jalr	-896(ra) # 800071ca <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    8000157c:	b9e080e7          	jalr	-1122(ra) # 80007116 <acquire>
  release(lk);
    80001580:	854a                	mv	a0,s2
    80001582:	00006097          	auipc	ra,0x6
    80001586:	c48080e7          	jalr	-952(ra) # 800071ca <release>
  ...
  release(&p->lock);
    ...
    800015a4:	c2a080e7          	jalr	-982(ra) # 800071ca <release>
  acquire(lk);
    800015a8:	854a                	mv	a0,s2
    800015aa:	00006097          	auipc	ra,0x6
    800015ae:	b6c080e7          	jalr	-1172(ra) # 80007116 <acquire>
}
...
00000000800015c0 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800015f0:	b2a080e7          	jalr	-1238(ra) # 80007116 <acquire>
    havekids = 0;
    ...
    8000168e:	a8c080e7          	jalr	-1396(ra) # 80007116 <acquire>
        if(np->state == ZOMBIE){
    ...
    8000169e:	b30080e7          	jalr	-1232(ra) # 800071ca <release>
        havekids = 1;
    ...
    800016ba:	b14080e7          	jalr	-1260(ra) # 800071ca <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000171c:	ab2080e7          	jalr	-1358(ra) # 800071ca <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000173a:	9e0080e7          	jalr	-1568(ra) # 80007116 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
00000000800017b8 <exit>:
{
  ...
  if(p == initproc)
    ...
    800017f4:	3dc080e7          	jalr	988(ra) # 80006bcc <panic>
      fileclose(f);
  ...
  acquire(&wait_lock);
    ...
    8000183e:	8dc080e7          	jalr	-1828(ra) # 80007116 <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    8000185e:	8bc080e7          	jalr	-1860(ra) # 80007116 <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    80001872:	95c080e7          	jalr	-1700(ra) # 800071ca <release>
  sched();
  ...
  panic("zombie exit");
    ...
    8000188a:	346080e7          	jalr	838(ra) # 80006bcc <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800018b4:	866080e7          	jalr	-1946(ra) # 80007116 <acquire>
    if(p->pid == pid){
    ...
    800018c4:	90a080e7          	jalr	-1782(ra) # 800071ca <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    800018e6:	8e8080e7          	jalr	-1816(ra) # 800071ca <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    800019ce:	24c080e7          	jalr	588(ra) # 80006c16 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a10:	20a080e7          	jalr	522(ra) # 80006c16 <printf>
    printf("\n");
    80001a14:	8552                	mv	a0,s4
    80001a16:	00005097          	auipc	ra,0x5
    80001a1a:	200080e7          	jalr	512(ra) # 80006c16 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001ae0:	5aa080e7          	jalr	1450(ra) # 80007086 <initlock>
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001bba:	560080e7          	jalr	1376(ra) # 80007116 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001bda:	5f4080e7          	jalr	1524(ra) # 800071ca <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c4a:	fd0080e7          	jalr	-48(ra) # 80006c16 <printf>
    80001c4e:	a029                	j	80001c58 <devintr+0x70>
      uartintr();
    80001c50:	00005097          	auipc	ra,0x5
    80001c54:	3e6080e7          	jalr	998(ra) # 80007036 <uartintr>
      plic_complete(irq);
    ...
    80001c74:	d7e080e7          	jalr	-642(ra) # 800059ee <e1000_intr>
...
0000000080001c9c <usertrap>:
{
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001cee:	53e080e7          	jalr	1342(ra) # 80007228 <lockfree_read4>
    ...
    80001d02:	ece080e7          	jalr	-306(ra) # 80006bcc <panic>
    if(lockfree_read4(&p->killed))
    80001d06:	02850513          	addi	a0,a0,40
    80001d0a:	00005097          	auipc	ra,0x5
    80001d0e:	51e080e7          	jalr	1310(ra) # 80007228 <lockfree_read4>
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001d38:	4f4080e7          	jalr	1268(ra) # 80007228 <lockfree_read4>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001d82:	e98080e7          	jalr	-360(ra) # 80006c16 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d9a:	e80080e7          	jalr	-384(ra) # 80006c16 <printf>
    p->killed = 1;
...
0000000080001dae <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001e08:	dc8080e7          	jalr	-568(ra) # 80006bcc <panic>
    ...
    80001e18:	db8080e7          	jalr	-584(ra) # 80006bcc <panic>
    printf("scause %p\n", scause);
    ...
    80001e2a:	df0080e7          	jalr	-528(ra) # 80006c16 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001ede:	cf2080e7          	jalr	-782(ra) # 80006bcc <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002046:	bd4080e7          	jalr	-1068(ra) # 80006c16 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    8000216c:	fae080e7          	jalr	-82(ra) # 80007116 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    800021c0:	00e080e7          	jalr	14(ra) # 800071ca <release>
  return 0;
    ...
    800021e2:	fec080e7          	jalr	-20(ra) # 800071ca <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002232:	ee8080e7          	jalr	-280(ra) # 80007116 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    8000224a:	f84080e7          	jalr	-124(ra) # 800071ca <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002282:	e08080e7          	jalr	-504(ra) # 80007086 <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    8000230a:	e10080e7          	jalr	-496(ra) # 80007116 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    8000234a:	e84080e7          	jalr	-380(ra) # 800071ca <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    80002388:	848080e7          	jalr	-1976(ra) # 80006bcc <panic>
      b->dev = dev;
    ...
    800023a8:	e26080e7          	jalr	-474(ra) # 800071ca <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002418:	7b8080e7          	jalr	1976(ra) # 80006bcc <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002450:	cca080e7          	jalr	-822(ra) # 80007116 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    8000249a:	d34080e7          	jalr	-716(ra) # 800071ca <release>
}
    ...
    800024b6:	71a080e7          	jalr	1818(ra) # 80006bcc <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024d2:	c48080e7          	jalr	-952(ra) # 80007116 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    800024e8:	ce6080e7          	jalr	-794(ra) # 800071ca <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000250e:	c0c080e7          	jalr	-1012(ra) # 80007116 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002524:	caa080e7          	jalr	-854(ra) # 800071ca <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    800025aa:	626080e7          	jalr	1574(ra) # 80006bcc <panic>
...
00000000800025ae <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    80002670:	560080e7          	jalr	1376(ra) # 80006bcc <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800027b6:	41a080e7          	jalr	1050(ra) # 80006bcc <panic>
...
00000000800027ba <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    800027da:	940080e7          	jalr	-1728(ra) # 80007116 <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002820:	9ae080e7          	jalr	-1618(ra) # 800071ca <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    80002850:	97e080e7          	jalr	-1666(ra) # 800071ca <release>
}
    ...
    80002872:	35e080e7          	jalr	862(ra) # 80006bcc <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    800028f2:	2de080e7          	jalr	734(ra) # 80006bcc <panic>
...
00000000800028f6 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80002918:	772080e7          	jalr	1906(ra) # 80007086 <initlock>
  for(i = 0; i < NINODE; i++) {
...
0000000080002956 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    800029d6:	1fa080e7          	jalr	506(ra) # 80006bcc <panic>
...
0000000080002ab0 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002ac8:	652080e7          	jalr	1618(ra) # 80007116 <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002ade:	6f0080e7          	jalr	1776(ra) # 800071ca <release>
}
...
0000000080002aee <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b2a:	0a6080e7          	jalr	166(ra) # 80006bcc <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002bac:	024080e7          	jalr	36(ra) # 80006bcc <panic>
...
0000000080002bb0 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002bf8:	fd8080e7          	jalr	-40(ra) # 80006bcc <panic>
...
0000000080002ca8 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002cc2:	458080e7          	jalr	1112(ra) # 80007116 <acquire>
  ...
  release(&itable.lock);
    ...
    80002ce0:	4ee080e7          	jalr	1262(ra) # 800071ca <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002d14:	4ba080e7          	jalr	1210(ra) # 800071ca <release>
    itrunc(ip);
    ...
    80002d4a:	3d0080e7          	jalr	976(ra) # 80007116 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003008:	bc8080e7          	jalr	-1080(ra) # 80006bcc <panic>
    ...
    80003018:	bb8080e7          	jalr	-1096(ra) # 80006bcc <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
000000008000341c <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003444:	c46080e7          	jalr	-954(ra) # 80007086 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800034d8:	c42080e7          	jalr	-958(ra) # 80007116 <acquire>
  while(1){
    if(log.committing){
    ...
    80003530:	c9e080e7          	jalr	-866(ra) # 800071ca <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003560:	bba080e7          	jalr	-1094(ra) # 80007116 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    80003588:	c46080e7          	jalr	-954(ra) # 800071ca <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800035a0:	b7a080e7          	jalr	-1158(ra) # 80007116 <acquire>
    log.committing = 0;
    ...
    800035b8:	c16080e7          	jalr	-1002(ra) # 800071ca <release>
}
    ...
    800035da:	5f6080e7          	jalr	1526(ra) # 80006bcc <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    800035f6:	bd8080e7          	jalr	-1064(ra) # 800071ca <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800036b4:	a66080e7          	jalr	-1434(ra) # 80007116 <acquire>
  ...
  release(&log.lock);
    ...
    8000376e:	a60080e7          	jalr	-1440(ra) # 800071ca <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    8000379c:	8ee080e7          	jalr	-1810(ra) # 80007086 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800037d0:	94a080e7          	jalr	-1718(ra) # 80007116 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    800037fe:	9d0080e7          	jalr	-1584(ra) # 800071ca <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003826:	8f4080e7          	jalr	-1804(ra) # 80007116 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    80003842:	98c080e7          	jalr	-1652(ra) # 800071ca <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000386c:	8ae080e7          	jalr	-1874(ra) # 80007116 <acquire>
  ...
  release(&lk->lk);
    ...
    8000387c:	952080e7          	jalr	-1710(ra) # 800071ca <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800038c4:	7c6080e7          	jalr	1990(ra) # 80007086 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800038e6:	834080e7          	jalr	-1996(ra) # 80007116 <acquire>
  ...
  release(&ftable.lock);
    ...
    80003912:	8bc080e7          	jalr	-1860(ra) # 800071ca <release>
  return 0;
    ...
    8000392a:	8a4080e7          	jalr	-1884(ra) # 800071ca <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003952:	7c8080e7          	jalr	1992(ra) # 80007116 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    8000396c:	862080e7          	jalr	-1950(ra) # 800071ca <release>
  return f;
}
    ...
    80003988:	248080e7          	jalr	584(ra) # 80006bcc <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800039ae:	76c080e7          	jalr	1900(ra) # 80007116 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800039ec:	7e2080e7          	jalr	2018(ra) # 800071ca <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003a0c:	958080e7          	jalr	-1704(ra) # 80006360 <sockclose>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003b1c:	8d8080e7          	jalr	-1832(ra) # 800063f0 <sockread>
  ...
  return r;
    ...
    80003ba8:	028080e7          	jalr	40(ra) # 80006bcc <panic>
    return -1;
    ...
    80003bbc:	12078263          	beqz	a5,80003ce0 <filewrite+0x128>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003bfe:	8c6080e7          	jalr	-1850(ra) # 800064c0 <sockwrite>
  else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80003cdc:	ef4080e7          	jalr	-268(ra) # 80006bcc <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003d4c:	33e080e7          	jalr	830(ra) # 80007086 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003dda:	340080e7          	jalr	832(ra) # 80007116 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003dfe:	3d0080e7          	jalr	976(ra) # 800071ca <release>
    kfree((char*)pi);
    ...
    80003e30:	39e080e7          	jalr	926(ra) # 800071ca <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003e66:	2b4080e7          	jalr	692(ra) # 80007116 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003e84:	34a080e7          	jalr	842(ra) # 800071ca <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003f26:	2a8080e7          	jalr	680(ra) # 800071ca <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f5c:	1be080e7          	jalr	446(ra) # 80007116 <acquire>
  ...
  release(&pi->lock);
    ...
    80003ff0:	1de080e7          	jalr	478(ra) # 800071ca <release>
  return i;
}
    ...
    80004010:	1be080e7          	jalr	446(ra) # 800071ca <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004118:	ab8080e7          	jalr	-1352(ra) # 80006bcc <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    8000454a:	686080e7          	jalr	1670(ra) # 80006bcc <panic>
    dp->nlink++;  // for ".."
...
00000000800048b8 <sys_unlink>:
{
  ...
  return 0;
    ...
    800049e4:	1ec080e7          	jalr	492(ra) # 80006bcc <panic>
...
sys_connect(void)
{
  ...
  if(sockalloc(&f, raddr, lport, rport) < 0)
    ...
    80005022:	21c080e7          	jalr	540(ra) # 8000623a <sockalloc>
...
000000008000527c <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    8000529a:	df0080e7          	jalr	-528(ra) # 80007086 <initlock>
  ...
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
  ...
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    ...
    8000539c:	834080e7          	jalr	-1996(ra) # 80006bcc <panic>
    ...
    800053ac:	824080e7          	jalr	-2012(ra) # 80006bcc <panic>
    ...
    800053bc:	814080e7          	jalr	-2028(ra) # 80006bcc <panic>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800053fa:	d20080e7          	jalr	-736(ra) # 80007116 <acquire>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  release(&disk.vdisk_lock);
    ...
    80005634:	b9a080e7          	jalr	-1126(ra) # 800071ca <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800056ae:	a6c080e7          	jalr	-1428(ra) # 80007116 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005740:	a8e080e7          	jalr	-1394(ra) # 800071ca <release>
}
    ...
    8000575c:	474080e7          	jalr	1140(ra) # 80006bcc <panic>
...
e1000_init(uint32 *xregs)
{
  ...
  initlock(&e1000_lock, "e1000");
    ...
    80005784:	906080e7          	jalr	-1786(ra) # 80007086 <initlock>
  ...
  for (i = 0; i < RX_RING_SIZE; i++) {
    ...
    8000583e:	41a080e7          	jalr	1050(ra) # 80005c54 <mbufalloc>
  ...
  regs[E1000_IMS] = (1 << 7); // RXDW -- Receiver Descriptor Write Back
    ...
    80005900:	2d0080e7          	jalr	720(ra) # 80006bcc <panic>
...
e1000_transmit(struct mbuf *m)
{
  ...
  acquire(&e1000_lock);
    ...
    80005922:	7f8080e7          	jalr	2040(ra) # 80007116 <acquire>
  ...
  if(!(desc->status & E1000_TXD_STAT_DD)){ // 是否传输完成，没传完的话说明环形缓冲区没了，是错误
    ...
    80005942:	02c7c783          	lbu	a5,44(a5)
    80005946:	8b85                	andi	a5,a5,1
    80005948:	cfc1                	beqz	a5,800059e0 <e1000_transmit+0xdc>
    release(&e1000_lock);
    return -1;
  }

  if(tx_mbufs[idx] != NULL){ // 这里的 buf 指向要发的数据包
    8000594a:	02049793          	slli	a5,s1,0x20
    8000594e:	9381                	srli	a5,a5,0x20
    80005950:	00379713          	slli	a4,a5,0x3
    80005954:	00019797          	auipc	a5,0x19
    80005958:	6ac78793          	addi	a5,a5,1708 # 8001f000 <e1000_lock>
    8000595c:	97ba                	add	a5,a5,a4
    8000595e:	1207b503          	ld	a0,288(a5)
    80005962:	c10d                	beqz	a0,80005984 <e1000_transmit+0x80>
    // 因为前面的判断，这里肯定是发送完了
    // tx_mbufs 是不需要分配的，直接指向 m 这个参数
    mbuffree(tx_mbufs[idx]);
    80005964:	00000097          	auipc	ra,0x0
    80005968:	348080e7          	jalr	840(ra) # 80005cac <mbuffree>
    tx_mbufs[idx] = NULL;
    8000596c:	02049793          	slli	a5,s1,0x20
    80005970:	9381                	srli	a5,a5,0x20
    80005972:	00379713          	slli	a4,a5,0x3
    80005976:	00019797          	auipc	a5,0x19
    8000597a:	68a78793          	addi	a5,a5,1674 # 8001f000 <e1000_lock>
    8000597e:	97ba                	add	a5,a5,a4
    80005980:	1207b023          	sd	zero,288(a5)
  }

  desc->addr = m->head;
    80005984:	00019517          	auipc	a0,0x19
    80005988:	67c50513          	addi	a0,a0,1660 # 8001f000 <e1000_lock>
    8000598c:	02049793          	slli	a5,s1,0x20
    80005990:	9381                	srli	a5,a5,0x20
    80005992:	00479713          	slli	a4,a5,0x4
    80005996:	972a                	add	a4,a4,a0
    80005998:	00893683          	ld	a3,8(s2)
    8000599c:	f314                	sd	a3,32(a4)
  desc->length = m->len;
    8000599e:	01092683          	lw	a3,16(s2)
    800059a2:	02d71423          	sh	a3,40(a4) # 4028 <_entry-0x7fffbfd8>

  desc->cmd = E1000_TXD_CMD_RS | E1000_TXD_CMD_EOP; // 表明这个标识符是包中最后一个，并且发送完了需要报告
    800059a6:	46a5                	li	a3,9
    800059a8:	02d705a3          	sb	a3,43(a4)
  
  tx_mbufs[idx] = m; // 方便之后清理
    800059ac:	078e                	slli	a5,a5,0x3
    800059ae:	97aa                	add	a5,a5,a0
    800059b0:	1327b023          	sd	s2,288(a5)

  regs[E1000_TDT] = (idx + 1) % TX_RING_SIZE;
    800059b4:	2485                	addiw	s1,s1,1
    800059b6:	88bd                	andi	s1,s1,15
    800059b8:	00004797          	auipc	a5,0x4
    800059bc:	6687b783          	ld	a5,1640(a5) # 8000a020 <regs>
    800059c0:	6711                	lui	a4,0x4
    800059c2:	97ba                	add	a5,a5,a4
    800059c4:	8097ac23          	sw	s1,-2024(a5)

  release(&e1000_lock);
    800059c8:	00002097          	auipc	ra,0x2
    800059cc:	802080e7          	jalr	-2046(ra) # 800071ca <release>
  return 0;
    800059d0:	4501                	li	a0,0
}
    800059d2:	70a2                	ld	ra,40(sp)
    800059d4:	7402                	ld	s0,32(sp)
    800059d6:	64e2                	ld	s1,24(sp)
    800059d8:	6942                	ld	s2,16(sp)
    800059da:	69a2                	ld	s3,8(sp)
    800059dc:	6145                	addi	sp,sp,48
    800059de:	8082                	ret
    release(&e1000_lock);
    800059e0:	854e                	mv	a0,s3
    800059e2:	00001097          	auipc	ra,0x1
    800059e6:	7e8080e7          	jalr	2024(ra) # 800071ca <release>
    return -1;
    800059ea:	557d                	li	a0,-1
    800059ec:	b7dd                	j	800059d2 <e1000_transmit+0xce>

00000000800059ee <e1000_intr>:
...
e1000_intr(void)
{
    800059ee:	7139                	addi	sp,sp,-64
    800059f0:	fc06                	sd	ra,56(sp)
    800059f2:	f822                	sd	s0,48(sp)
    800059f4:	f426                	sd	s1,40(sp)
    800059f6:	f04a                	sd	s2,32(sp)
    800059f8:	ec4e                	sd	s3,24(sp)
    800059fa:	e852                	sd	s4,16(sp)
    800059fc:	e456                	sd	s5,8(sp)
    800059fe:	e05a                	sd	s6,0(sp)
    80005a00:	0080                	addi	s0,sp,64
  // tell the e1000 we've seen this interrupt;
  // without this the e1000 won't raise any
  // further interrupts.
  regs[E1000_ICR] = 0xffffffff;
    80005a02:	00004797          	auipc	a5,0x4
    80005a06:	61e7b783          	ld	a5,1566(a5) # 8000a020 <regs>
    80005a0a:	577d                	li	a4,-1
    80005a0c:	0ce7a023          	sw	a4,192(a5)
    uint idx = (regs[E1000_RDT] + 1) % RX_RING_SIZE; //head 到 tail 是一个空的缓冲区
    80005a10:	670d                	lui	a4,0x3
    80005a12:	97ba                	add	a5,a5,a4
    80005a14:	8187a783          	lw	a5,-2024(a5)
    80005a18:	2785                	addiw	a5,a5,1
    80005a1a:	00f7f913          	andi	s2,a5,15
    if(!(desc->status & E1000_RXD_STAT_DD)){
    80005a1e:	00491793          	slli	a5,s2,0x4
    80005a22:	00019717          	auipc	a4,0x19
    80005a26:	5de70713          	addi	a4,a4,1502 # 8001f000 <e1000_lock>
    80005a2a:	97ba                	add	a5,a5,a4
    80005a2c:	1ac7c783          	lbu	a5,428(a5)
    80005a30:	8b85                	andi	a5,a5,1
    80005a32:	c7ad                	beqz	a5,80005a9c <e1000_intr+0xae>
    rx_mbufs[idx]->len = desc->length; // desc->addr 已经被设置成了 rx_mbufs 里
    80005a34:	89ba                	mv	s3,a4
    regs[E1000_RDT] = idx;
    80005a36:	00004a97          	auipc	s5,0x4
    80005a3a:	5eaa8a93          	addi	s5,s5,1514 # 8000a020 <regs>
    80005a3e:	6a0d                	lui	s4,0x3
    rx_mbufs[idx]->len = desc->length; // desc->addr 已经被设置成了 rx_mbufs 里
    80005a40:	00391b13          	slli	s6,s2,0x3
    80005a44:	9b4e                	add	s6,s6,s3
    80005a46:	2a0b3783          	ld	a5,672(s6) # 22a0 <_entry-0x7fffdd60>
    80005a4a:	00491493          	slli	s1,s2,0x4
    80005a4e:	94ce                	add	s1,s1,s3
    80005a50:	1a84d703          	lhu	a4,424(s1)
    80005a54:	cb98                	sw	a4,16(a5)
    net_rx(rx_mbufs[idx]);
    80005a56:	2a0b3503          	ld	a0,672(s6)
    80005a5a:	00000097          	auipc	ra,0x0
    80005a5e:	3c6080e7          	jalr	966(ra) # 80005e20 <net_rx>
    rx_mbufs[idx] = mbufalloc(0);
    80005a62:	4501                	li	a0,0
    80005a64:	00000097          	auipc	ra,0x0
    80005a68:	1f0080e7          	jalr	496(ra) # 80005c54 <mbufalloc>
    80005a6c:	2aab3023          	sd	a0,672(s6)
    desc->addr = rx_mbufs[idx]->head;
    80005a70:	651c                	ld	a5,8(a0)
    80005a72:	1af4b023          	sd	a5,416(s1)
    desc->status = 0;
    80005a76:	1a048623          	sb	zero,428(s1)
    regs[E1000_RDT] = idx;
    80005a7a:	000ab783          	ld	a5,0(s5)
    80005a7e:	97d2                	add	a5,a5,s4
    80005a80:	8127ac23          	sw	s2,-2024(a5)
    uint idx = (regs[E1000_RDT] + 1) % RX_RING_SIZE; //head 到 tail 是一个空的缓冲区
    80005a84:	8187a783          	lw	a5,-2024(a5)
    80005a88:	2785                	addiw	a5,a5,1
    80005a8a:	00f7f913          	andi	s2,a5,15
    if(!(desc->status & E1000_RXD_STAT_DD)){
    80005a8e:	00491793          	slli	a5,s2,0x4
    80005a92:	97ce                	add	a5,a5,s3
    80005a94:	1ac7c783          	lbu	a5,428(a5)
    80005a98:	8b85                	andi	a5,a5,1
    80005a9a:	f3dd                	bnez	a5,80005a40 <e1000_intr+0x52>
  ...
  e1000_recv();
    ...
    80005aa2:	7902                	ld	s2,32(sp)
    80005aa4:	69e2                	ld	s3,24(sp)
    80005aa6:	6a42                	ld	s4,16(sp)
    80005aa8:	6aa2                	ld	s5,8(sp)
    80005aaa:	6b02                	ld	s6,0(sp)
    80005aac:	6121                	addi	sp,sp,64
    80005aae:	8082                	ret

0000000080005ab0 <in_cksum>:
...
{
    80005ab0:	1101                	addi	sp,sp,-32
    80005ab2:	ec22                	sd	s0,24(sp)
    80005ab4:	1000                	addi	s0,sp,32
  int nleft = len;
  const unsigned short *w = (const unsigned short *)addr;
  unsigned int sum = 0;
  unsigned short answer = 0;
    80005ab6:	fe041723          	sh	zero,-18(s0)
  /*
  ...
  while (nleft > 1)  {
    ...
    80005abc:	04b7d963          	bge	a5,a1,80005b0e <in_cksum+0x5e>
    80005ac0:	ffe5879b          	addiw	a5,a1,-2
    80005ac4:	0017d61b          	srliw	a2,a5,0x1
    80005ac8:	0017d71b          	srliw	a4,a5,0x1
    80005acc:	0705                	addi	a4,a4,1
    80005ace:	0706                	slli	a4,a4,0x1
    80005ad0:	972a                	add	a4,a4,a0
  unsigned int sum = 0;
    80005ad2:	4781                	li	a5,0
    sum += *w++;
    80005ad4:	0509                	addi	a0,a0,2
    80005ad6:	ffe55683          	lhu	a3,-2(a0)
    80005ada:	9fb5                	addw	a5,a5,a3
  while (nleft > 1)  {
    80005adc:	fee51ce3          	bne	a0,a4,80005ad4 <in_cksum+0x24>
    80005ae0:	35f9                	addiw	a1,a1,-2
    80005ae2:	0016169b          	slliw	a3,a2,0x1
    80005ae6:	9d95                	subw	a1,a1,a3
    nleft -= 2;
  }

  /* mop up an odd byte, if necessary */
  if (nleft == 1) {
    80005ae8:	4685                	li	a3,1
    80005aea:	02d58563          	beq	a1,a3,80005b14 <in_cksum+0x64>
  ...
  sum = (sum & 0xffff) + (sum >> 16);
    80005aee:	03079513          	slli	a0,a5,0x30
    80005af2:	9141                	srli	a0,a0,0x30
    80005af4:	0107d79b          	srliw	a5,a5,0x10
    80005af8:	9fa9                	addw	a5,a5,a0
  sum += (sum >> 16);
    80005afa:	0107d51b          	srliw	a0,a5,0x10
  /* guaranteed now that the lower 16 bits of sum are correct */

  answer = ~sum; /* truncate to 16 bits */
    80005afe:	9d3d                	addw	a0,a0,a5
    80005b00:	fff54513          	not	a0,a0
  return answer;
}
    80005b04:	1542                	slli	a0,a0,0x30
    80005b06:	9141                	srli	a0,a0,0x30
    80005b08:	6462                	ld	s0,24(sp)
    80005b0a:	6105                	addi	sp,sp,32
    80005b0c:	8082                	ret
  const unsigned short *w = (const unsigned short *)addr;
    80005b0e:	872a                	mv	a4,a0
  unsigned int sum = 0;
    80005b10:	4781                	li	a5,0
    80005b12:	bfd9                	j	80005ae8 <in_cksum+0x38>
    *(unsigned char *)(&answer) = *(const unsigned char *)w;
    80005b14:	00074703          	lbu	a4,0(a4)
    80005b18:	fee40723          	sb	a4,-18(s0)
    sum += answer;
    80005b1c:	fee45703          	lhu	a4,-18(s0)
    80005b20:	9fb9                	addw	a5,a5,a4
    80005b22:	b7f1                	j	80005aee <in_cksum+0x3e>

0000000080005b24 <mbufpull>:
{
    80005b24:	1141                	addi	sp,sp,-16
    80005b26:	e422                	sd	s0,8(sp)
    80005b28:	0800                	addi	s0,sp,16
    80005b2a:	87aa                	mv	a5,a0
  char *tmp = m->head;
    80005b2c:	6508                	ld	a0,8(a0)
  if (m->len < len)
    80005b2e:	4b98                	lw	a4,16(a5)
    80005b30:	00b76b63          	bltu	a4,a1,80005b46 <mbufpull+0x22>
  m->len -= len;
    80005b34:	9f0d                	subw	a4,a4,a1
    80005b36:	cb98                	sw	a4,16(a5)
  m->head += len;
    80005b38:	1582                	slli	a1,a1,0x20
    80005b3a:	9181                	srli	a1,a1,0x20
    80005b3c:	95aa                	add	a1,a1,a0
    80005b3e:	e78c                	sd	a1,8(a5)
}
    80005b40:	6422                	ld	s0,8(sp)
    80005b42:	0141                	addi	sp,sp,16
    80005b44:	8082                	ret
    return 0;
    80005b46:	4501                	li	a0,0
    80005b48:	bfe5                	j	80005b40 <mbufpull+0x1c>

0000000080005b4a <mbufpush>:
{
    80005b4a:	87aa                	mv	a5,a0
  m->head -= len;
    80005b4c:	02059713          	slli	a4,a1,0x20
    80005b50:	9301                	srli	a4,a4,0x20
    80005b52:	6508                	ld	a0,8(a0)
    80005b54:	8d19                	sub	a0,a0,a4
    80005b56:	e788                	sd	a0,8(a5)
  if (m->head < m->buf)
    80005b58:	01478713          	addi	a4,a5,20
    80005b5c:	00e56663          	bltu	a0,a4,80005b68 <mbufpush+0x1e>
  m->len += len;
    80005b60:	4b98                	lw	a4,16(a5)
    80005b62:	9db9                	addw	a1,a1,a4
    80005b64:	cb8c                	sw	a1,16(a5)
}
    80005b66:	8082                	ret
{
    ...
    80005b74:	c7850513          	addi	a0,a0,-904 # 800097e8 <syscalls+0x410>
    80005b78:	00001097          	auipc	ra,0x1
    80005b7c:	054080e7          	jalr	84(ra) # 80006bcc <panic>

0000000080005b80 <net_tx_eth>:
...
net_tx_eth(struct mbuf *m, uint16 ethtype)
{
    ...
    80005b86:	ec26                	sd	s1,24(sp)
    80005b88:	e84a                	sd	s2,16(sp)
    80005b8a:	e44e                	sd	s3,8(sp)
  ...
  ethhdr = mbufpushhdr(m, *ethhdr);
    80005b92:	45b9                	li	a1,14
    80005b94:	00000097          	auipc	ra,0x0
    80005b98:	fb6080e7          	jalr	-74(ra) # 80005b4a <mbufpush>
    80005b9c:	84aa                	mv	s1,a0
  memmove(ethhdr->shost, local_mac, ETHADDR_LEN);
    80005b9e:	4619                	li	a2,6
    80005ba0:	00004597          	auipc	a1,0x4
    80005ba4:	d0058593          	addi	a1,a1,-768 # 800098a0 <local_mac>
    80005ba8:	0519                	addi	a0,a0,6
    80005baa:	ffffa097          	auipc	ra,0xffffa
    80005bae:	62e080e7          	jalr	1582(ra) # 800001d8 <memmove>
  // In a real networking stack, dhost would be set to the address discovered
  // through ARP. Because we don't support enough of the ARP protocol, set it
  // to broadcast instead.
  memmove(ethhdr->dhost, broadcast_mac, ETHADDR_LEN);
    80005bb2:	4619                	li	a2,6
    80005bb4:	00004597          	auipc	a1,0x4
    80005bb8:	ce458593          	addi	a1,a1,-796 # 80009898 <broadcast_mac>
    80005bbc:	8526                	mv	a0,s1
    80005bbe:	ffffa097          	auipc	ra,0xffffa
    80005bc2:	61a080e7          	jalr	1562(ra) # 800001d8 <memmove>
// endianness support
//
...
static inline uint16 bswaps(uint16 val)
{
  return (((val & 0x00ffU) << 8) |
    80005bc6:	0089579b          	srliw	a5,s2,0x8
  ethhdr->type = htons(ethtype);
    80005bca:	00f48623          	sb	a5,12(s1)
    80005bce:	012486a3          	sb	s2,13(s1)
  if (e1000_transmit(m)) {
    80005bd2:	854e                	mv	a0,s3
    80005bd4:	00000097          	auipc	ra,0x0
    80005bd8:	d30080e7          	jalr	-720(ra) # 80005904 <e1000_transmit>
    80005bdc:	e901                	bnez	a0,80005bec <net_tx_eth+0x6c>
    mbuffree(m);
  }
}
    ...
    80005be6:	69a2                	ld	s3,8(sp)
    80005be8:	6145                	addi	sp,sp,48
    80005bea:	8082                	ret
  kfree(m);
    80005bec:	854e                	mv	a0,s3
    80005bee:	ffffa097          	auipc	ra,0xffffa
    80005bf2:	42e080e7          	jalr	1070(ra) # 8000001c <kfree>
}
    80005bf6:	b7e5                	j	80005bde <net_tx_eth+0x5e>

0000000080005bf8 <mbufput>:
{
    80005bf8:	87aa                	mv	a5,a0
  char *tmp = m->head + m->len;
    80005bfa:	4918                	lw	a4,16(a0)
    80005bfc:	02071693          	slli	a3,a4,0x20
    80005c00:	9281                	srli	a3,a3,0x20
    80005c02:	6508                	ld	a0,8(a0)
    80005c04:	9536                	add	a0,a0,a3
  m->len += len;
    80005c06:	9f2d                	addw	a4,a4,a1
    80005c08:	0007069b          	sext.w	a3,a4
    80005c0c:	cb98                	sw	a4,16(a5)
  if (m->len > MBUF_SIZE)
    80005c0e:	6785                	lui	a5,0x1
    80005c10:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    80005c14:	00d7e363          	bltu	a5,a3,80005c1a <mbufput+0x22>
}
    80005c18:	8082                	ret
{
    ...
    panic("mbufput");
    80005c22:	00004517          	auipc	a0,0x4
    80005c26:	bd650513          	addi	a0,a0,-1066 # 800097f8 <syscalls+0x420>
    80005c2a:	00001097          	auipc	ra,0x1
    80005c2e:	fa2080e7          	jalr	-94(ra) # 80006bcc <panic>

0000000080005c32 <mbuftrim>:
{
    80005c32:	1141                	addi	sp,sp,-16
    80005c34:	e422                	sd	s0,8(sp)
    80005c36:	0800                	addi	s0,sp,16
  if (len > m->len)
    80005c38:	491c                	lw	a5,16(a0)
    80005c3a:	00b7eb63          	bltu	a5,a1,80005c50 <mbuftrim+0x1e>
  m->len -= len;
    80005c3e:	9f8d                	subw	a5,a5,a1
    80005c40:	c91c                	sw	a5,16(a0)
  return m->head + m->len;
    80005c42:	1782                	slli	a5,a5,0x20
    80005c44:	9381                	srli	a5,a5,0x20
    80005c46:	6508                	ld	a0,8(a0)
    ...
    80005c52:	bfe5                	j	80005c4a <mbuftrim+0x18>

0000000080005c54 <mbufalloc>:
{
    80005c54:	1101                	addi	sp,sp,-32
    80005c56:	ec06                	sd	ra,24(sp)
    80005c58:	e822                	sd	s0,16(sp)
    80005c5a:	e426                	sd	s1,8(sp)
    80005c5c:	e04a                	sd	s2,0(sp)
    80005c5e:	1000                	addi	s0,sp,32
  if (headroom > MBUF_SIZE)
    80005c60:	6785                	lui	a5,0x1
    80005c62:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    return 0;
    80005c66:	4901                	li	s2,0
  if (headroom > MBUF_SIZE)
    80005c68:	02a7eb63          	bltu	a5,a0,80005c9e <mbufalloc+0x4a>
    80005c6c:	84aa                	mv	s1,a0
  m = kalloc();
    80005c6e:	ffffa097          	auipc	ra,0xffffa
    80005c72:	4aa080e7          	jalr	1194(ra) # 80000118 <kalloc>
    80005c76:	892a                	mv	s2,a0
  if (m == 0)
    80005c78:	c11d                	beqz	a0,80005c9e <mbufalloc+0x4a>
  m->next = 0;
    80005c7a:	00053023          	sd	zero,0(a0)
  m->head = (char *)m->buf + headroom;
    80005c7e:	0551                	addi	a0,a0,20
    80005c80:	1482                	slli	s1,s1,0x20
    80005c82:	9081                	srli	s1,s1,0x20
    80005c84:	94aa                	add	s1,s1,a0
    80005c86:	00993423          	sd	s1,8(s2)
  m->len = 0;
    80005c8a:	00092823          	sw	zero,16(s2)
  memset(m->buf, 0, sizeof(m->buf));
    80005c8e:	6605                	lui	a2,0x1
    80005c90:	80060613          	addi	a2,a2,-2048 # 800 <_entry-0x7ffff800>
    80005c94:	4581                	li	a1,0
    80005c96:	ffffa097          	auipc	ra,0xffffa
    80005c9a:	4e2080e7          	jalr	1250(ra) # 80000178 <memset>
}
    80005c9e:	854a                	mv	a0,s2
    80005ca0:	60e2                	ld	ra,24(sp)
    80005ca2:	6442                	ld	s0,16(sp)
    80005ca4:	64a2                	ld	s1,8(sp)
    80005ca6:	6902                	ld	s2,0(sp)
    80005ca8:	6105                	addi	sp,sp,32
    80005caa:	8082                	ret

0000000080005cac <mbuffree>:
{
  ...
  kfree(m);
    80005cb4:	ffffa097          	auipc	ra,0xffffa
    80005cb8:	368080e7          	jalr	872(ra) # 8000001c <kfree>
}
...
0000000080005cc4 <mbufq_pushtail>:
{
    80005cc4:	1141                	addi	sp,sp,-16
    80005cc6:	e422                	sd	s0,8(sp)
    80005cc8:	0800                	addi	s0,sp,16
  m->next = 0;
    80005cca:	0005b023          	sd	zero,0(a1)
  if (!q->head){
    80005cce:	611c                	ld	a5,0(a0)
    80005cd0:	c799                	beqz	a5,80005cde <mbufq_pushtail+0x1a>
  q->tail->next = m;
    80005cd2:	651c                	ld	a5,8(a0)
    80005cd4:	e38c                	sd	a1,0(a5)
  q->tail = m;
    80005cd6:	e50c                	sd	a1,8(a0)
}
    80005cd8:	6422                	ld	s0,8(sp)
    80005cda:	0141                	addi	sp,sp,16
    80005cdc:	8082                	ret
    q->head = q->tail = m;
    80005cde:	e50c                	sd	a1,8(a0)
    80005ce0:	e10c                	sd	a1,0(a0)
    return;
    80005ce2:	bfdd                	j	80005cd8 <mbufq_pushtail+0x14>

0000000080005ce4 <mbufq_pophead>:
{
    80005ce4:	1141                	addi	sp,sp,-16
    80005ce6:	e422                	sd	s0,8(sp)
    80005ce8:	0800                	addi	s0,sp,16
    80005cea:	87aa                	mv	a5,a0
  struct mbuf *head = q->head;
    80005cec:	6108                	ld	a0,0(a0)
  if (!head)
    80005cee:	c119                	beqz	a0,80005cf4 <mbufq_pophead+0x10>
  q->head = head->next;
    80005cf0:	6118                	ld	a4,0(a0)
    80005cf2:	e398                	sd	a4,0(a5)
}
    80005cf4:	6422                	ld	s0,8(sp)
    80005cf6:	0141                	addi	sp,sp,16
    80005cf8:	8082                	ret

0000000080005cfa <mbufq_empty>:
{
    80005cfa:	1141                	addi	sp,sp,-16
    80005cfc:	e422                	sd	s0,8(sp)
    80005cfe:	0800                	addi	s0,sp,16
  return q->head == 0;
    80005d00:	6108                	ld	a0,0(a0)
}
    80005d02:	00153513          	seqz	a0,a0
    80005d06:	6422                	ld	s0,8(sp)
    80005d08:	0141                	addi	sp,sp,16
    80005d0a:	8082                	ret

0000000080005d0c <mbufq_init>:
{
    80005d0c:	1141                	addi	sp,sp,-16
    80005d0e:	e422                	sd	s0,8(sp)
    80005d10:	0800                	addi	s0,sp,16
  q->head = 0;
    80005d12:	00053023          	sd	zero,0(a0)
}
    80005d16:	6422                	ld	s0,8(sp)
    80005d18:	0141                	addi	sp,sp,16
    80005d1a:	8082                	ret

0000000080005d1c <net_tx_udp>:
           ...
           uint16 sport, uint16 dport)
{
    ...
    80005d26:	e44e                	sd	s3,8(sp)
    80005d28:	e052                	sd	s4,0(sp)
    80005d2a:	1800                	addi	s0,sp,48
    80005d2c:	8a2a                	mv	s4,a0
    80005d2e:	892e                	mv	s2,a1
    80005d30:	89b2                	mv	s3,a2
    80005d32:	84b6                	mv	s1,a3
  struct udp *udphdr;

  // put the UDP header
  udphdr = mbufpushhdr(m, *udphdr);
    80005d34:	45a1                	li	a1,8
    80005d36:	00000097          	auipc	ra,0x0
    80005d3a:	e14080e7          	jalr	-492(ra) # 80005b4a <mbufpush>
    80005d3e:	0089d61b          	srliw	a2,s3,0x8
    80005d42:	0089999b          	slliw	s3,s3,0x8
    80005d46:	00c9e9b3          	or	s3,s3,a2
  udphdr->sport = htons(sport);
    80005d4a:	01351023          	sh	s3,0(a0)
    80005d4e:	0084d69b          	srliw	a3,s1,0x8
    80005d52:	0084949b          	slliw	s1,s1,0x8
    80005d56:	8cd5                	or	s1,s1,a3
  udphdr->dport = htons(dport);
    80005d58:	00951123          	sh	s1,2(a0)
  udphdr->ulen = htons(m->len);
    80005d5c:	010a2783          	lw	a5,16(s4) # 3010 <_entry-0x7fffcff0>
    80005d60:	0087d713          	srli	a4,a5,0x8
    80005d64:	0087979b          	slliw	a5,a5,0x8
    80005d68:	0ff77713          	andi	a4,a4,255
    80005d6c:	8fd9                	or	a5,a5,a4
    80005d6e:	00f51223          	sh	a5,4(a0)
  udphdr->sum = 0; // zero means no checksum is provided
    80005d72:	00051323          	sh	zero,6(a0)
  iphdr = mbufpushhdr(m, *iphdr);
    80005d76:	45d1                	li	a1,20
    80005d78:	8552                	mv	a0,s4
    80005d7a:	00000097          	auipc	ra,0x0
    80005d7e:	dd0080e7          	jalr	-560(ra) # 80005b4a <mbufpush>
    80005d82:	84aa                	mv	s1,a0
  memset(iphdr, 0, sizeof(*iphdr));
    80005d84:	4651                	li	a2,20
    80005d86:	4581                	li	a1,0
    80005d88:	ffffa097          	auipc	ra,0xffffa
    80005d8c:	3f0080e7          	jalr	1008(ra) # 80000178 <memset>
  iphdr->ip_vhl = (4 << 4) | (20 >> 2);
    80005d90:	04500793          	li	a5,69
    80005d94:	00f48023          	sb	a5,0(s1)
  iphdr->ip_p = proto;
    80005d98:	47c5                	li	a5,17
    80005d9a:	00f484a3          	sb	a5,9(s1)
  iphdr->ip_src = htonl(local_ip);
    80005d9e:	0f0207b7          	lui	a5,0xf020
    80005da2:	27a9                	addiw	a5,a5,10
    80005da4:	c4dc                	sw	a5,12(s1)
          ((val & 0xff00U) >> 8));
}
...
static inline uint32 bswapl(uint32 val)
{
  return (((val & 0x000000ffUL) << 24) |
    80005da6:	0189179b          	slliw	a5,s2,0x18
          ((val & 0x0000ff00UL) << 8) |
          ((val & 0x00ff0000UL) >> 8) |
          ((val & 0xff000000UL) >> 24));
    80005daa:	0189571b          	srliw	a4,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005dae:	8fd9                	or	a5,a5,a4
          ((val & 0x0000ff00UL) << 8) |
    80005db0:	0089171b          	slliw	a4,s2,0x8
    80005db4:	00ff06b7          	lui	a3,0xff0
    80005db8:	8f75                	and	a4,a4,a3
          ((val & 0x00ff0000UL) >> 8) |
    80005dba:	8fd9                	or	a5,a5,a4
    80005dbc:	0089591b          	srliw	s2,s2,0x8
    80005dc0:	65c1                	lui	a1,0x10
    80005dc2:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80005dc6:	00b97933          	and	s2,s2,a1
    80005dca:	0127e933          	or	s2,a5,s2
  iphdr->ip_dst = htonl(dip);
    80005dce:	0124a823          	sw	s2,16(s1)
  iphdr->ip_len = htons(m->len);
    80005dd2:	010a2783          	lw	a5,16(s4)
  return (((val & 0x00ffU) << 8) |
    80005dd6:	0087d713          	srli	a4,a5,0x8
    80005dda:	0087979b          	slliw	a5,a5,0x8
    80005dde:	0ff77713          	andi	a4,a4,255
    80005de2:	8fd9                	or	a5,a5,a4
    80005de4:	00f49123          	sh	a5,2(s1)
  iphdr->ip_ttl = 100;
    80005de8:	06400793          	li	a5,100
    80005dec:	00f48423          	sb	a5,8(s1)
  iphdr->ip_sum = in_cksum((unsigned char *)iphdr, sizeof(*iphdr));
    80005df0:	45d1                	li	a1,20
    80005df2:	8526                	mv	a0,s1
    80005df4:	00000097          	auipc	ra,0x0
    80005df8:	cbc080e7          	jalr	-836(ra) # 80005ab0 <in_cksum>
    80005dfc:	00a49523          	sh	a0,10(s1)
  net_tx_eth(m, ETHTYPE_IP);
    80005e00:	6585                	lui	a1,0x1
    80005e02:	80058593          	addi	a1,a1,-2048 # 800 <_entry-0x7ffff800>
    80005e06:	8552                	mv	a0,s4
    80005e08:	00000097          	auipc	ra,0x0
    80005e0c:	d78080e7          	jalr	-648(ra) # 80005b80 <net_tx_eth>
  ...
  net_tx_ip(m, IPPROTO_UDP, dip);
    ...
    80005e14:	64e2                	ld	s1,24(sp)
    80005e16:	6942                	ld	s2,16(sp)
    80005e18:	69a2                	ld	s3,8(sp)
    80005e1a:	6a02                	ld	s4,0(sp)
    80005e1c:	6145                	addi	sp,sp,48
    80005e1e:	8082                	ret

0000000080005e20 <net_rx>:
}
...
{
    80005e20:	715d                	addi	sp,sp,-80
    80005e22:	e486                	sd	ra,72(sp)
    80005e24:	e0a2                	sd	s0,64(sp)
    80005e26:	fc26                	sd	s1,56(sp)
    80005e28:	f84a                	sd	s2,48(sp)
    80005e2a:	f44e                	sd	s3,40(sp)
    80005e2c:	f052                	sd	s4,32(sp)
    80005e2e:	ec56                	sd	s5,24(sp)
    80005e30:	0880                	addi	s0,sp,80
    80005e32:	84aa                	mv	s1,a0
  struct eth *ethhdr;
  uint16 type;

  ethhdr = mbufpullhdr(m, *ethhdr);
    80005e34:	45b9                	li	a1,14
    80005e36:	00000097          	auipc	ra,0x0
    80005e3a:	cee080e7          	jalr	-786(ra) # 80005b24 <mbufpull>
  if (!ethhdr) {
    80005e3e:	c521                	beqz	a0,80005e86 <net_rx+0x66>
    mbuffree(m);
    return;
  }

  type = ntohs(ethhdr->type);
    80005e40:	00c54783          	lbu	a5,12(a0)
    80005e44:	00d54703          	lbu	a4,13(a0)
    80005e48:	0722                	slli	a4,a4,0x8
    80005e4a:	8fd9                	or	a5,a5,a4
    80005e4c:	0087979b          	slliw	a5,a5,0x8
    80005e50:	8321                	srli	a4,a4,0x8
    80005e52:	8fd9                	or	a5,a5,a4
    80005e54:	17c2                	slli	a5,a5,0x30
    80005e56:	93c1                	srli	a5,a5,0x30
  if (type == ETHTYPE_IP)
    80005e58:	8007871b          	addiw	a4,a5,-2048
    80005e5c:	cb1d                	beqz	a4,80005e92 <net_rx+0x72>
    net_rx_ip(m);
  else if (type == ETHTYPE_ARP)
    80005e5e:	2781                	sext.w	a5,a5
    80005e60:	6705                	lui	a4,0x1
    80005e62:	80670713          	addi	a4,a4,-2042 # 806 <_entry-0x7ffff7fa>
    80005e66:	18e78e63          	beq	a5,a4,80006002 <net_rx+0x1e2>
  kfree(m);
    80005e6a:	8526                	mv	a0,s1
    80005e6c:	ffffa097          	auipc	ra,0xffffa
    80005e70:	1b0080e7          	jalr	432(ra) # 8000001c <kfree>
    net_rx_arp(m);
  else
    mbuffree(m);
}
    80005e74:	60a6                	ld	ra,72(sp)
    80005e76:	6406                	ld	s0,64(sp)
    80005e78:	74e2                	ld	s1,56(sp)
    80005e7a:	7942                	ld	s2,48(sp)
    80005e7c:	79a2                	ld	s3,40(sp)
    80005e7e:	7a02                	ld	s4,32(sp)
    80005e80:	6ae2                	ld	s5,24(sp)
    80005e82:	6161                	addi	sp,sp,80
    80005e84:	8082                	ret
  kfree(m);
    80005e86:	8526                	mv	a0,s1
    80005e88:	ffffa097          	auipc	ra,0xffffa
    80005e8c:	194080e7          	jalr	404(ra) # 8000001c <kfree>
}
    80005e90:	b7d5                	j	80005e74 <net_rx+0x54>
  iphdr = mbufpullhdr(m, *iphdr);
    80005e92:	45d1                	li	a1,20
    80005e94:	8526                	mv	a0,s1
    80005e96:	00000097          	auipc	ra,0x0
    80005e9a:	c8e080e7          	jalr	-882(ra) # 80005b24 <mbufpull>
    80005e9e:	892a                	mv	s2,a0
  if (!iphdr)
    80005ea0:	c519                	beqz	a0,80005eae <net_rx+0x8e>
  if (iphdr->ip_vhl != ((4 << 4) | (20 >> 2)))
    80005ea2:	00054703          	lbu	a4,0(a0)
    80005ea6:	04500793          	li	a5,69
    80005eaa:	00f70863          	beq	a4,a5,80005eba <net_rx+0x9a>
  kfree(m);
    80005eae:	8526                	mv	a0,s1
    80005eb0:	ffffa097          	auipc	ra,0xffffa
    80005eb4:	16c080e7          	jalr	364(ra) # 8000001c <kfree>
}
    80005eb8:	bf75                	j	80005e74 <net_rx+0x54>
  if (in_cksum((unsigned char *)iphdr, sizeof(*iphdr)))
    80005eba:	45d1                	li	a1,20
    80005ebc:	00000097          	auipc	ra,0x0
    80005ec0:	bf4080e7          	jalr	-1036(ra) # 80005ab0 <in_cksum>
    80005ec4:	f56d                	bnez	a0,80005eae <net_rx+0x8e>
    80005ec6:	00695783          	lhu	a5,6(s2)
    80005eca:	0087d713          	srli	a4,a5,0x8
    80005ece:	0087979b          	slliw	a5,a5,0x8
    80005ed2:	0ff77713          	andi	a4,a4,255
    80005ed6:	8fd9                	or	a5,a5,a4
  if (htons(iphdr->ip_off) != 0)
    80005ed8:	17c2                	slli	a5,a5,0x30
    80005eda:	93c1                	srli	a5,a5,0x30
    80005edc:	fbe9                	bnez	a5,80005eae <net_rx+0x8e>
  if (htonl(iphdr->ip_dst) != local_ip)
    80005ede:	01092703          	lw	a4,16(s2)
  return (((val & 0x000000ffUL) << 24) |
    80005ee2:	0187179b          	slliw	a5,a4,0x18
          ((val & 0xff000000UL) >> 24));
    80005ee6:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005eea:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80005eec:	0087169b          	slliw	a3,a4,0x8
    80005ef0:	00ff0637          	lui	a2,0xff0
    80005ef4:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80005ef6:	8fd5                	or	a5,a5,a3
    80005ef8:	0087571b          	srliw	a4,a4,0x8
    80005efc:	66c1                	lui	a3,0x10
    80005efe:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80005f02:	8f75                	and	a4,a4,a3
    80005f04:	8fd9                	or	a5,a5,a4
    80005f06:	2781                	sext.w	a5,a5
    80005f08:	0a000737          	lui	a4,0xa000
    80005f0c:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80005f10:	f8e79fe3          	bne	a5,a4,80005eae <net_rx+0x8e>
  if (iphdr->ip_p != IPPROTO_UDP)
    80005f14:	00994703          	lbu	a4,9(s2)
    80005f18:	47c5                	li	a5,17
    80005f1a:	f8f71ae3          	bne	a4,a5,80005eae <net_rx+0x8e>
  return (((val & 0x00ffU) << 8) |
    80005f1e:	00295783          	lhu	a5,2(s2)
    80005f22:	0087d713          	srli	a4,a5,0x8
    80005f26:	0087999b          	slliw	s3,a5,0x8
    80005f2a:	0ff77793          	andi	a5,a4,255
    80005f2e:	00f9e9b3          	or	s3,s3,a5
    80005f32:	19c2                	slli	s3,s3,0x30
    80005f34:	0309d993          	srli	s3,s3,0x30
  len = ntohs(iphdr->ip_len) - sizeof(*iphdr);
    80005f38:	fec9879b          	addiw	a5,s3,-20
    80005f3c:	03079a13          	slli	s4,a5,0x30
    80005f40:	030a5a13          	srli	s4,s4,0x30
  udphdr = mbufpullhdr(m, *udphdr);
    80005f44:	45a1                	li	a1,8
    80005f46:	8526                	mv	a0,s1
    80005f48:	00000097          	auipc	ra,0x0
    80005f4c:	bdc080e7          	jalr	-1060(ra) # 80005b24 <mbufpull>
    80005f50:	8aaa                	mv	s5,a0
  if (!udphdr)
    80005f52:	c915                	beqz	a0,80005f86 <net_rx+0x166>
    80005f54:	00455783          	lhu	a5,4(a0)
    80005f58:	0087d713          	srli	a4,a5,0x8
    80005f5c:	0087979b          	slliw	a5,a5,0x8
    80005f60:	0ff77713          	andi	a4,a4,255
    80005f64:	8fd9                	or	a5,a5,a4
  if (ntohs(udphdr->ulen) != len)
    80005f66:	2a01                	sext.w	s4,s4
    80005f68:	17c2                	slli	a5,a5,0x30
    80005f6a:	93c1                	srli	a5,a5,0x30
    80005f6c:	00fa1d63          	bne	s4,a5,80005f86 <net_rx+0x166>
  len -= sizeof(*udphdr);
    80005f70:	fe49879b          	addiw	a5,s3,-28
  if (len > m->len)
    80005f74:	0107979b          	slliw	a5,a5,0x10
    80005f78:	0107d79b          	srliw	a5,a5,0x10
    80005f7c:	0007871b          	sext.w	a4,a5
    80005f80:	488c                	lw	a1,16(s1)
    80005f82:	00e5f863          	bgeu	a1,a4,80005f92 <net_rx+0x172>
  kfree(m);
    80005f86:	8526                	mv	a0,s1
    80005f88:	ffffa097          	auipc	ra,0xffffa
    80005f8c:	094080e7          	jalr	148(ra) # 8000001c <kfree>
}
    80005f90:	b5d5                	j	80005e74 <net_rx+0x54>
  mbuftrim(m, m->len - len);
    80005f92:	9d9d                	subw	a1,a1,a5
    80005f94:	8526                	mv	a0,s1
    80005f96:	00000097          	auipc	ra,0x0
    80005f9a:	c9c080e7          	jalr	-868(ra) # 80005c32 <mbuftrim>
  sip = ntohl(iphdr->ip_src);
    80005f9e:	00c92783          	lw	a5,12(s2)
    80005fa2:	000ad703          	lhu	a4,0(s5)
    80005fa6:	00875693          	srli	a3,a4,0x8
    80005faa:	0087171b          	slliw	a4,a4,0x8
    80005fae:	0ff6f693          	andi	a3,a3,255
    80005fb2:	8ed9                	or	a3,a3,a4
    80005fb4:	002ad703          	lhu	a4,2(s5)
    80005fb8:	00875613          	srli	a2,a4,0x8
    80005fbc:	0087171b          	slliw	a4,a4,0x8
    80005fc0:	0ff67613          	andi	a2,a2,255
    80005fc4:	8e59                	or	a2,a2,a4
  return (((val & 0x000000ffUL) << 24) |
    80005fc6:	0187971b          	slliw	a4,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80005fca:	0187d59b          	srliw	a1,a5,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005fce:	8f4d                	or	a4,a4,a1
          ((val & 0x0000ff00UL) << 8) |
    80005fd0:	0087959b          	slliw	a1,a5,0x8
    80005fd4:	00ff0537          	lui	a0,0xff0
    80005fd8:	8de9                	and	a1,a1,a0
          ((val & 0x00ff0000UL) >> 8) |
    80005fda:	8f4d                	or	a4,a4,a1
    80005fdc:	0087d79b          	srliw	a5,a5,0x8
    80005fe0:	65c1                	lui	a1,0x10
    80005fe2:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80005fe6:	8fed                	and	a5,a5,a1
    80005fe8:	8fd9                	or	a5,a5,a4
  sockrecvudp(m, sip, dport, sport);
    80005fea:	16c2                	slli	a3,a3,0x30
    80005fec:	92c1                	srli	a3,a3,0x30
    80005fee:	1642                	slli	a2,a2,0x30
    80005ff0:	9241                	srli	a2,a2,0x30
    80005ff2:	0007859b          	sext.w	a1,a5
    80005ff6:	8526                	mv	a0,s1
    80005ff8:	00000097          	auipc	ra,0x0
    80005ffc:	55c080e7          	jalr	1372(ra) # 80006554 <sockrecvudp>
  return;
    80006000:	bd95                	j	80005e74 <net_rx+0x54>
  arphdr = mbufpullhdr(m, *arphdr);
    80006002:	45f1                	li	a1,28
    80006004:	8526                	mv	a0,s1
    80006006:	00000097          	auipc	ra,0x0
    8000600a:	b1e080e7          	jalr	-1250(ra) # 80005b24 <mbufpull>
    8000600e:	892a                	mv	s2,a0
  if (!arphdr)
    80006010:	c179                	beqz	a0,800060d6 <net_rx+0x2b6>
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006012:	00054783          	lbu	a5,0(a0) # ff0000 <_entry-0x7f010000>
    80006016:	00154703          	lbu	a4,1(a0)
    8000601a:	0722                	slli	a4,a4,0x8
    8000601c:	8fd9                	or	a5,a5,a4
  return (((val & 0x00ffU) << 8) |
    8000601e:	0087979b          	slliw	a5,a5,0x8
    80006022:	8321                	srli	a4,a4,0x8
    80006024:	8fd9                	or	a5,a5,a4
    80006026:	17c2                	slli	a5,a5,0x30
    80006028:	93c1                	srli	a5,a5,0x30
    8000602a:	4705                	li	a4,1
    8000602c:	0ae79563          	bne	a5,a4,800060d6 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006030:	00254783          	lbu	a5,2(a0)
    80006034:	00354703          	lbu	a4,3(a0)
    80006038:	0722                	slli	a4,a4,0x8
    8000603a:	8fd9                	or	a5,a5,a4
    8000603c:	0087979b          	slliw	a5,a5,0x8
    80006040:	8321                	srli	a4,a4,0x8
    80006042:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006044:	0107979b          	slliw	a5,a5,0x10
    80006048:	0107d79b          	srliw	a5,a5,0x10
    8000604c:	8007879b          	addiw	a5,a5,-2048
    80006050:	e3d9                	bnez	a5,800060d6 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006052:	00454703          	lbu	a4,4(a0)
    80006056:	4799                	li	a5,6
    80006058:	06f71f63          	bne	a4,a5,800060d6 <net_rx+0x2b6>
      arphdr->hln != ETHADDR_LEN ||
    8000605c:	00554703          	lbu	a4,5(a0)
    80006060:	4791                	li	a5,4
    80006062:	06f71a63          	bne	a4,a5,800060d6 <net_rx+0x2b6>
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    80006066:	00654783          	lbu	a5,6(a0)
    8000606a:	00754703          	lbu	a4,7(a0)
    8000606e:	0722                	slli	a4,a4,0x8
    80006070:	8fd9                	or	a5,a5,a4
    80006072:	0087979b          	slliw	a5,a5,0x8
    80006076:	8321                	srli	a4,a4,0x8
    80006078:	8fd9                	or	a5,a5,a4
    8000607a:	17c2                	slli	a5,a5,0x30
    8000607c:	93c1                	srli	a5,a5,0x30
    8000607e:	4705                	li	a4,1
    80006080:	04e79b63          	bne	a5,a4,800060d6 <net_rx+0x2b6>
  tip = ntohl(arphdr->tip); // target IP address
    80006084:	01854783          	lbu	a5,24(a0)
    80006088:	01954703          	lbu	a4,25(a0)
    8000608c:	0722                	slli	a4,a4,0x8
    8000608e:	8f5d                	or	a4,a4,a5
    80006090:	01a54783          	lbu	a5,26(a0)
    80006094:	07c2                	slli	a5,a5,0x10
    80006096:	8f5d                	or	a4,a4,a5
    80006098:	01b54783          	lbu	a5,27(a0)
    8000609c:	07e2                	slli	a5,a5,0x18
    8000609e:	8fd9                	or	a5,a5,a4
    800060a0:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    800060a4:	0187979b          	slliw	a5,a5,0x18
          ((val & 0xff000000UL) >> 24));
    800060a8:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800060ac:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    800060ae:	0087169b          	slliw	a3,a4,0x8
    800060b2:	00ff0637          	lui	a2,0xff0
    800060b6:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    800060b8:	8fd5                	or	a5,a5,a3
    800060ba:	0087571b          	srliw	a4,a4,0x8
    800060be:	66c1                	lui	a3,0x10
    800060c0:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    800060c4:	8f75                	and	a4,a4,a3
    800060c6:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    800060c8:	2781                	sext.w	a5,a5
    800060ca:	0a000737          	lui	a4,0xa000
    800060ce:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    800060d2:	00e78863          	beq	a5,a4,800060e2 <net_rx+0x2c2>
  kfree(m);
    800060d6:	8526                	mv	a0,s1
    800060d8:	ffffa097          	auipc	ra,0xffffa
    800060dc:	f44080e7          	jalr	-188(ra) # 8000001c <kfree>
}
    800060e0:	bb51                	j	80005e74 <net_rx+0x54>
  memmove(smac, arphdr->sha, ETHADDR_LEN); // sender's ethernet address
    800060e2:	4619                	li	a2,6
    800060e4:	00850593          	addi	a1,a0,8
    800060e8:	fb840513          	addi	a0,s0,-72
    800060ec:	ffffa097          	auipc	ra,0xffffa
    800060f0:	0ec080e7          	jalr	236(ra) # 800001d8 <memmove>
  sip = ntohl(arphdr->sip); // sender's IP address (qemu's slirp)
    800060f4:	00e94783          	lbu	a5,14(s2)
    800060f8:	00f94703          	lbu	a4,15(s2)
    800060fc:	0722                	slli	a4,a4,0x8
    800060fe:	8f5d                	or	a4,a4,a5
    80006100:	01094783          	lbu	a5,16(s2)
    80006104:	07c2                	slli	a5,a5,0x10
    80006106:	8f5d                	or	a4,a4,a5
    80006108:	01194783          	lbu	a5,17(s2)
    8000610c:	07e2                	slli	a5,a5,0x18
    8000610e:	8fd9                	or	a5,a5,a4
    80006110:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    80006114:	0187991b          	slliw	s2,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006118:	0187579b          	srliw	a5,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    8000611c:	00f96933          	or	s2,s2,a5
          ((val & 0x0000ff00UL) << 8) |
    80006120:	0087179b          	slliw	a5,a4,0x8
    80006124:	00ff06b7          	lui	a3,0xff0
    80006128:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    8000612a:	00f96933          	or	s2,s2,a5
    8000612e:	0087579b          	srliw	a5,a4,0x8
    80006132:	6741                	lui	a4,0x10
    80006134:	f0070713          	addi	a4,a4,-256 # ff00 <_entry-0x7fff0100>
    80006138:	8ff9                	and	a5,a5,a4
    8000613a:	00f96933          	or	s2,s2,a5
    8000613e:	2901                	sext.w	s2,s2
  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006140:	08000513          	li	a0,128
    80006144:	00000097          	auipc	ra,0x0
    80006148:	b10080e7          	jalr	-1264(ra) # 80005c54 <mbufalloc>
    8000614c:	8a2a                	mv	s4,a0
  if (!m)
    8000614e:	d541                	beqz	a0,800060d6 <net_rx+0x2b6>
  arphdr = mbufputhdr(m, *arphdr);
    80006150:	45f1                	li	a1,28
    80006152:	00000097          	auipc	ra,0x0
    80006156:	aa6080e7          	jalr	-1370(ra) # 80005bf8 <mbufput>
    8000615a:	89aa                	mv	s3,a0
  arphdr->hrd = htons(ARP_HRD_ETHER);
    8000615c:	00050023          	sb	zero,0(a0)
    80006160:	4785                	li	a5,1
    80006162:	00f500a3          	sb	a5,1(a0)
  arphdr->pro = htons(ETHTYPE_IP);
    80006166:	47a1                	li	a5,8
    80006168:	00f50123          	sb	a5,2(a0)
    8000616c:	000501a3          	sb	zero,3(a0)
  arphdr->hln = ETHADDR_LEN;
    80006170:	4799                	li	a5,6
    80006172:	00f50223          	sb	a5,4(a0)
  arphdr->pln = sizeof(uint32);
    80006176:	4791                	li	a5,4
    80006178:	00f502a3          	sb	a5,5(a0)
  arphdr->op = htons(op);
    8000617c:	00050323          	sb	zero,6(a0)
    80006180:	4a89                	li	s5,2
    80006182:	015503a3          	sb	s5,7(a0)
  memmove(arphdr->sha, local_mac, ETHADDR_LEN);
    80006186:	4619                	li	a2,6
    80006188:	00003597          	auipc	a1,0x3
    8000618c:	71858593          	addi	a1,a1,1816 # 800098a0 <local_mac>
    80006190:	0521                	addi	a0,a0,8
    80006192:	ffffa097          	auipc	ra,0xffffa
    80006196:	046080e7          	jalr	70(ra) # 800001d8 <memmove>
  arphdr->sip = htonl(local_ip);
    8000619a:	47a9                	li	a5,10
    8000619c:	00f98723          	sb	a5,14(s3)
    800061a0:	000987a3          	sb	zero,15(s3)
    800061a4:	01598823          	sb	s5,16(s3)
    800061a8:	47bd                	li	a5,15
    800061aa:	00f988a3          	sb	a5,17(s3)
  memmove(arphdr->tha, dmac, ETHADDR_LEN);
    800061ae:	4619                	li	a2,6
    800061b0:	fb840593          	addi	a1,s0,-72
    800061b4:	01298513          	addi	a0,s3,18
    800061b8:	ffffa097          	auipc	ra,0xffffa
    800061bc:	020080e7          	jalr	32(ra) # 800001d8 <memmove>
  return (((val & 0x000000ffUL) << 24) |
    800061c0:	0189171b          	slliw	a4,s2,0x18
          ((val & 0xff000000UL) >> 24));
    800061c4:	0189579b          	srliw	a5,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800061c8:	8f5d                	or	a4,a4,a5
          ((val & 0x0000ff00UL) << 8) |
    800061ca:	0089179b          	slliw	a5,s2,0x8
    800061ce:	00ff06b7          	lui	a3,0xff0
    800061d2:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    800061d4:	8f5d                	or	a4,a4,a5
    800061d6:	0089579b          	srliw	a5,s2,0x8
    800061da:	66c1                	lui	a3,0x10
    800061dc:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    800061e0:	8ff5                	and	a5,a5,a3
    800061e2:	8fd9                	or	a5,a5,a4
  arphdr->tip = htonl(dip);
    800061e4:	00e98c23          	sb	a4,24(s3)
    800061e8:	0087d71b          	srliw	a4,a5,0x8
    800061ec:	00e98ca3          	sb	a4,25(s3)
    800061f0:	0107d71b          	srliw	a4,a5,0x10
    800061f4:	00e98d23          	sb	a4,26(s3)
    800061f8:	0187d79b          	srliw	a5,a5,0x18
    800061fc:	00f98da3          	sb	a5,27(s3)
  net_tx_eth(m, ETHTYPE_ARP);
    80006200:	6585                	lui	a1,0x1
    80006202:	80658593          	addi	a1,a1,-2042 # 806 <_entry-0x7ffff7fa>
    80006206:	8552                	mv	a0,s4
    80006208:	00000097          	auipc	ra,0x0
    8000620c:	978080e7          	jalr	-1672(ra) # 80005b80 <net_tx_eth>
  return 0;
    80006210:	b5d9                	j	800060d6 <net_rx+0x2b6>

0000000080006212 <sockinit>:
...
sockinit(void)
{
  ...
  initlock(&lock, "socktbl");
    8000621a:	00003597          	auipc	a1,0x3
    8000621e:	5e658593          	addi	a1,a1,1510 # 80009800 <syscalls+0x428>
    80006222:	00019517          	auipc	a0,0x19
    80006226:	0fe50513          	addi	a0,a0,254 # 8001f320 <lock>
    8000622a:	00001097          	auipc	ra,0x1
    8000622e:	e5c080e7          	jalr	-420(ra) # 80007086 <initlock>
}
    80006232:	60a2                	ld	ra,8(sp)
    80006234:	6402                	ld	s0,0(sp)
    80006236:	0141                	addi	sp,sp,16
    80006238:	8082                	ret

000000008000623a <sockalloc>:

int
sockalloc(struct file **f, uint32 raddr, uint16 lport, uint16 rport)
{
    8000623a:	7139                	addi	sp,sp,-64
    8000623c:	fc06                	sd	ra,56(sp)
    8000623e:	f822                	sd	s0,48(sp)
    80006240:	f426                	sd	s1,40(sp)
    80006242:	f04a                	sd	s2,32(sp)
    80006244:	ec4e                	sd	s3,24(sp)
    80006246:	e852                	sd	s4,16(sp)
    80006248:	e456                	sd	s5,8(sp)
    8000624a:	0080                	addi	s0,sp,64
    8000624c:	892a                	mv	s2,a0
    8000624e:	84ae                	mv	s1,a1
    80006250:	8a32                	mv	s4,a2
    80006252:	89b6                	mv	s3,a3
  struct sock *si, *pos;

  si = 0;
  *f = 0;
    80006254:	00053023          	sd	zero,0(a0)
  if ((*f = filealloc()) == 0)
    80006258:	ffffd097          	auipc	ra,0xffffd
    8000625c:	678080e7          	jalr	1656(ra) # 800038d0 <filealloc>
    80006260:	00a93023          	sd	a0,0(s2)
    80006264:	c975                	beqz	a0,80006358 <sockalloc+0x11e>
    goto bad;
  if ((si = (struct sock*)kalloc()) == 0)
    80006266:	ffffa097          	auipc	ra,0xffffa
    8000626a:	eb2080e7          	jalr	-334(ra) # 80000118 <kalloc>
    8000626e:	8aaa                	mv	s5,a0
    80006270:	c15d                	beqz	a0,80006316 <sockalloc+0xdc>
    goto bad;

  // initialize objects
  si->raddr = raddr;
    80006272:	c504                	sw	s1,8(a0)
  si->lport = lport;
    80006274:	01451623          	sh	s4,12(a0)
  si->rport = rport;
    80006278:	01351723          	sh	s3,14(a0)
  initlock(&si->lock, "sock");
    8000627c:	00003597          	auipc	a1,0x3
    80006280:	58c58593          	addi	a1,a1,1420 # 80009808 <syscalls+0x430>
    80006284:	0541                	addi	a0,a0,16
    80006286:	00001097          	auipc	ra,0x1
    8000628a:	e00080e7          	jalr	-512(ra) # 80007086 <initlock>
  mbufq_init(&si->rxq);
    8000628e:	028a8513          	addi	a0,s5,40
    80006292:	00000097          	auipc	ra,0x0
    80006296:	a7a080e7          	jalr	-1414(ra) # 80005d0c <mbufq_init>
  (*f)->type = FD_SOCK;
    8000629a:	00093783          	ld	a5,0(s2)
    8000629e:	4711                	li	a4,4
    800062a0:	c398                	sw	a4,0(a5)
  (*f)->readable = 1;
    800062a2:	00093703          	ld	a4,0(s2)
    800062a6:	4785                	li	a5,1
    800062a8:	00f70423          	sb	a5,8(a4)
  (*f)->writable = 1;
    800062ac:	00093703          	ld	a4,0(s2)
    800062b0:	00f704a3          	sb	a5,9(a4)
  (*f)->sock = si;
    800062b4:	00093783          	ld	a5,0(s2)
    800062b8:	0357b023          	sd	s5,32(a5) # f020020 <_entry-0x70fdffe0>

  // add to list of sockets
  acquire(&lock);
    800062bc:	00019517          	auipc	a0,0x19
    800062c0:	06450513          	addi	a0,a0,100 # 8001f320 <lock>
    800062c4:	00001097          	auipc	ra,0x1
    800062c8:	e52080e7          	jalr	-430(ra) # 80007116 <acquire>
  pos = sockets;
    800062cc:	00004597          	auipc	a1,0x4
    800062d0:	d5c5b583          	ld	a1,-676(a1) # 8000a028 <sockets>
  while (pos) {
    800062d4:	c9b1                	beqz	a1,80006328 <sockalloc+0xee>
  pos = sockets;
    800062d6:	87ae                	mv	a5,a1
    if (pos->raddr == raddr &&
    800062d8:	000a061b          	sext.w	a2,s4
        pos->lport == lport &&
    800062dc:	0009869b          	sext.w	a3,s3
    800062e0:	a019                	j	800062e6 <sockalloc+0xac>
	pos->rport == rport) {
      release(&lock);
      goto bad;
    }
  ...
  while (pos) {
    800062e4:	c3b1                	beqz	a5,80006328 <sockalloc+0xee>
    if (pos->raddr == raddr &&
    800062e6:	4798                	lw	a4,8(a5)
    800062e8:	fe971de3          	bne	a4,s1,800062e2 <sockalloc+0xa8>
    800062ec:	00c7d703          	lhu	a4,12(a5)
    800062f0:	fec719e3          	bne	a4,a2,800062e2 <sockalloc+0xa8>
        pos->lport == lport &&
    800062f4:	00e7d703          	lhu	a4,14(a5)
    800062f8:	fed715e3          	bne	a4,a3,800062e2 <sockalloc+0xa8>
      release(&lock);
    800062fc:	00019517          	auipc	a0,0x19
    80006300:	02450513          	addi	a0,a0,36 # 8001f320 <lock>
    80006304:	00001097          	auipc	ra,0x1
    80006308:	ec6080e7          	jalr	-314(ra) # 800071ca <release>
  release(&lock);
  return 0;
...
bad:
  if (si)
    kfree((char*)si);
    8000630c:	8556                	mv	a0,s5
    8000630e:	ffffa097          	auipc	ra,0xffffa
    80006312:	d0e080e7          	jalr	-754(ra) # 8000001c <kfree>
  if (*f)
    80006316:	00093503          	ld	a0,0(s2)
    8000631a:	c129                	beqz	a0,8000635c <sockalloc+0x122>
    fileclose(*f);
    8000631c:	ffffd097          	auipc	ra,0xffffd
    80006320:	670080e7          	jalr	1648(ra) # 8000398c <fileclose>
  return -1;
    80006324:	557d                	li	a0,-1
    80006326:	a005                	j	80006346 <sockalloc+0x10c>
  si->next = sockets;
    80006328:	00bab023          	sd	a1,0(s5)
  sockets = si;
    8000632c:	00004797          	auipc	a5,0x4
    80006330:	cf57be23          	sd	s5,-772(a5) # 8000a028 <sockets>
  release(&lock);
    80006334:	00019517          	auipc	a0,0x19
    80006338:	fec50513          	addi	a0,a0,-20 # 8001f320 <lock>
    8000633c:	00001097          	auipc	ra,0x1
    80006340:	e8e080e7          	jalr	-370(ra) # 800071ca <release>
  return 0;
    80006344:	4501                	li	a0,0
}
    80006346:	70e2                	ld	ra,56(sp)
    80006348:	7442                	ld	s0,48(sp)
    8000634a:	74a2                	ld	s1,40(sp)
    8000634c:	7902                	ld	s2,32(sp)
    8000634e:	69e2                	ld	s3,24(sp)
    80006350:	6a42                	ld	s4,16(sp)
    80006352:	6aa2                	ld	s5,8(sp)
    80006354:	6121                	addi	sp,sp,64
    80006356:	8082                	ret
  return -1;
    80006358:	557d                	li	a0,-1
    8000635a:	b7f5                	j	80006346 <sockalloc+0x10c>
    8000635c:	557d                	li	a0,-1
    8000635e:	b7e5                	j	80006346 <sockalloc+0x10c>

0000000080006360 <sockclose>:
...
sockclose(struct sock *si)
{
    ...
    80006368:	e04a                	sd	s2,0(sp)
    8000636a:	1000                	addi	s0,sp,32
    8000636c:	892a                	mv	s2,a0
  struct sock **pos;
  struct mbuf *m;

  // remove from list of sockets
  acquire(&lock);
    8000636e:	00019517          	auipc	a0,0x19
    80006372:	fb250513          	addi	a0,a0,-78 # 8001f320 <lock>
    80006376:	00001097          	auipc	ra,0x1
    8000637a:	da0080e7          	jalr	-608(ra) # 80007116 <acquire>
  pos = &sockets;
    8000637e:	00004797          	auipc	a5,0x4
    80006382:	caa7b783          	ld	a5,-854(a5) # 8000a028 <sockets>
  while (*pos) {
    80006386:	cb99                	beqz	a5,8000639c <sockclose+0x3c>
    if (*pos == si){
    80006388:	02f90563          	beq	s2,a5,800063b2 <sockclose+0x52>
      *pos = si->next;
      break;
    }
    pos = &(*pos)->next;
    8000638c:	873e                	mv	a4,a5
    8000638e:	639c                	ld	a5,0(a5)
  while (*pos) {
    80006390:	c791                	beqz	a5,8000639c <sockclose+0x3c>
    if (*pos == si){
    80006392:	fef91de3          	bne	s2,a5,8000638c <sockclose+0x2c>
      *pos = si->next;
    80006396:	00093783          	ld	a5,0(s2)
    8000639a:	e31c                	sd	a5,0(a4)
  }
  release(&lock);
    8000639c:	00019517          	auipc	a0,0x19
    800063a0:	f8450513          	addi	a0,a0,-124 # 8001f320 <lock>
    800063a4:	00001097          	auipc	ra,0x1
    800063a8:	e26080e7          	jalr	-474(ra) # 800071ca <release>

  // free any pending mbufs
  while (!mbufq_empty(&si->rxq)) {
    800063ac:	02890493          	addi	s1,s2,40
    800063b0:	a839                	j	800063ce <sockclose+0x6e>
  pos = &sockets;
    800063b2:	00004717          	auipc	a4,0x4
    800063b6:	c7670713          	addi	a4,a4,-906 # 8000a028 <sockets>
    800063ba:	bff1                	j	80006396 <sockclose+0x36>
    m = mbufq_pophead(&si->rxq);
    800063bc:	8526                	mv	a0,s1
    800063be:	00000097          	auipc	ra,0x0
    800063c2:	926080e7          	jalr	-1754(ra) # 80005ce4 <mbufq_pophead>
    mbuffree(m);
    800063c6:	00000097          	auipc	ra,0x0
    800063ca:	8e6080e7          	jalr	-1818(ra) # 80005cac <mbuffree>
  while (!mbufq_empty(&si->rxq)) {
    800063ce:	8526                	mv	a0,s1
    800063d0:	00000097          	auipc	ra,0x0
    800063d4:	92a080e7          	jalr	-1750(ra) # 80005cfa <mbufq_empty>
    800063d8:	d175                	beqz	a0,800063bc <sockclose+0x5c>
  }

  kfree((char*)si);
    800063da:	854a                	mv	a0,s2
    800063dc:	ffffa097          	auipc	ra,0xffffa
    800063e0:	c40080e7          	jalr	-960(ra) # 8000001c <kfree>
}
    800063e4:	60e2                	ld	ra,24(sp)
    800063e6:	6442                	ld	s0,16(sp)
    800063e8:	64a2                	ld	s1,8(sp)
    800063ea:	6902                	ld	s2,0(sp)
    800063ec:	6105                	addi	sp,sp,32
    800063ee:	8082                	ret

00000000800063f0 <sockread>:
...
sockread(struct sock *si, uint64 addr, int n)
{
    ...
    80006404:	8a2e                	mv	s4,a1
    80006406:	8ab2                	mv	s5,a2
  struct proc *pr = myproc();
    80006408:	ffffb097          	auipc	ra,0xffffb
    8000640c:	a98080e7          	jalr	-1384(ra) # 80000ea0 <myproc>
    80006410:	892a                	mv	s2,a0
  struct mbuf *m;
  int len;

  acquire(&si->lock);
    80006412:	01048993          	addi	s3,s1,16
    80006416:	854e                	mv	a0,s3
    80006418:	00001097          	auipc	ra,0x1
    8000641c:	cfe080e7          	jalr	-770(ra) # 80007116 <acquire>
  while (mbufq_empty(&si->rxq) && !pr->killed) {
    80006420:	02848493          	addi	s1,s1,40
    80006424:	8526                	mv	a0,s1
    80006426:	00000097          	auipc	ra,0x0
    8000642a:	8d4080e7          	jalr	-1836(ra) # 80005cfa <mbufq_empty>
    8000642e:	c919                	beqz	a0,80006444 <sockread+0x54>
    80006430:	02892783          	lw	a5,40(s2)
    80006434:	eba5                	bnez	a5,800064a4 <sockread+0xb4>
    sleep(&si->rxq, &si->lock);
    80006436:	85ce                	mv	a1,s3
    80006438:	8526                	mv	a0,s1
    8000643a:	ffffb097          	auipc	ra,0xffffb
    8000643e:	122080e7          	jalr	290(ra) # 8000155c <sleep>
    80006442:	b7cd                	j	80006424 <sockread+0x34>
  }
  if (pr->killed) {
    80006444:	02892783          	lw	a5,40(s2)
    80006448:	efb1                	bnez	a5,800064a4 <sockread+0xb4>
    release(&si->lock);
    return -1;
  }
  m = mbufq_pophead(&si->rxq);
    ...
    80006450:	898080e7          	jalr	-1896(ra) # 80005ce4 <mbufq_pophead>
    80006454:	84aa                	mv	s1,a0
  release(&si->lock);
    80006456:	854e                	mv	a0,s3
    80006458:	00001097          	auipc	ra,0x1
    8000645c:	d72080e7          	jalr	-654(ra) # 800071ca <release>

  len = m->len;
    80006460:	489c                	lw	a5,16(s1)
  if (len > n)
    80006462:	89be                	mv	s3,a5
    80006464:	00fad363          	bge	s5,a5,8000646a <sockread+0x7a>
    80006468:	89d6                	mv	s3,s5
    8000646a:	2981                	sext.w	s3,s3
    len = n;
  if (copyout(pr->pagetable, addr, m->head, len) == -1) {
    8000646c:	86ce                	mv	a3,s3
    8000646e:	6490                	ld	a2,8(s1)
    80006470:	85d2                	mv	a1,s4
    80006472:	05093503          	ld	a0,80(s2)
    80006476:	ffffa097          	auipc	ra,0xffffa
    8000647a:	6f0080e7          	jalr	1776(ra) # 80000b66 <copyout>
    8000647e:	892a                	mv	s2,a0
    80006480:	57fd                	li	a5,-1
    80006482:	02f50863          	beq	a0,a5,800064b2 <sockread+0xc2>
    mbuffree(m);
    return -1;
  }
  mbuffree(m);
    ...
    8000648c:	824080e7          	jalr	-2012(ra) # 80005cac <mbuffree>
  return len;
}
    80006490:	854e                	mv	a0,s3
    ...
    800064a6:	00001097          	auipc	ra,0x1
    800064aa:	d24080e7          	jalr	-732(ra) # 800071ca <release>
    return -1;
    800064ae:	59fd                	li	s3,-1
    800064b0:	b7c5                	j	80006490 <sockread+0xa0>
    mbuffree(m);
    800064b2:	8526                	mv	a0,s1
    800064b4:	fffff097          	auipc	ra,0xfffff
    800064b8:	7f8080e7          	jalr	2040(ra) # 80005cac <mbuffree>
    return -1;
    800064bc:	89ca                	mv	s3,s2
    800064be:	bfc9                	j	80006490 <sockread+0xa0>

00000000800064c0 <sockwrite>:

int
sockwrite(struct sock *si, uint64 addr, int n)
{
    800064c0:	7139                	addi	sp,sp,-64
    800064c2:	fc06                	sd	ra,56(sp)
    800064c4:	f822                	sd	s0,48(sp)
    800064c6:	f426                	sd	s1,40(sp)
    800064c8:	f04a                	sd	s2,32(sp)
    800064ca:	ec4e                	sd	s3,24(sp)
    800064cc:	e852                	sd	s4,16(sp)
    800064ce:	e456                	sd	s5,8(sp)
    800064d0:	0080                	addi	s0,sp,64
    800064d2:	8aaa                	mv	s5,a0
    800064d4:	89ae                	mv	s3,a1
    800064d6:	8932                	mv	s2,a2
  struct proc *pr = myproc();
    800064d8:	ffffb097          	auipc	ra,0xffffb
    800064dc:	9c8080e7          	jalr	-1592(ra) # 80000ea0 <myproc>
    800064e0:	8a2a                	mv	s4,a0
  struct mbuf *m;

  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    800064e2:	08000513          	li	a0,128
    800064e6:	fffff097          	auipc	ra,0xfffff
    800064ea:	76e080e7          	jalr	1902(ra) # 80005c54 <mbufalloc>
  if (!m)
    800064ee:	c12d                	beqz	a0,80006550 <sockwrite+0x90>
    800064f0:	84aa                	mv	s1,a0
    return -1;

  if (copyin(pr->pagetable, mbufput(m, n), addr, n) == -1) {
    800064f2:	050a3a03          	ld	s4,80(s4)
    800064f6:	85ca                	mv	a1,s2
    800064f8:	fffff097          	auipc	ra,0xfffff
    800064fc:	700080e7          	jalr	1792(ra) # 80005bf8 <mbufput>
    80006500:	85aa                	mv	a1,a0
    80006502:	86ca                	mv	a3,s2
    80006504:	864e                	mv	a2,s3
    80006506:	8552                	mv	a0,s4
    80006508:	ffffa097          	auipc	ra,0xffffa
    8000650c:	6ea080e7          	jalr	1770(ra) # 80000bf2 <copyin>
    80006510:	89aa                	mv	s3,a0
    80006512:	57fd                	li	a5,-1
    80006514:	02f50863          	beq	a0,a5,80006544 <sockwrite+0x84>
    mbuffree(m);
    return -1;
  }
  net_tx_udp(m, si->raddr, si->lport, si->rport);
    80006518:	00ead683          	lhu	a3,14(s5)
    8000651c:	00cad603          	lhu	a2,12(s5)
    80006520:	008aa583          	lw	a1,8(s5)
    80006524:	8526                	mv	a0,s1
    80006526:	fffff097          	auipc	ra,0xfffff
    8000652a:	7f6080e7          	jalr	2038(ra) # 80005d1c <net_tx_udp>
  return n;
    8000652e:	89ca                	mv	s3,s2
}
    80006530:	854e                	mv	a0,s3
    80006532:	70e2                	ld	ra,56(sp)
    80006534:	7442                	ld	s0,48(sp)
    80006536:	74a2                	ld	s1,40(sp)
    80006538:	7902                	ld	s2,32(sp)
    8000653a:	69e2                	ld	s3,24(sp)
    8000653c:	6a42                	ld	s4,16(sp)
    8000653e:	6aa2                	ld	s5,8(sp)
    80006540:	6121                	addi	sp,sp,64
    80006542:	8082                	ret
    mbuffree(m);
    80006544:	8526                	mv	a0,s1
    80006546:	fffff097          	auipc	ra,0xfffff
    8000654a:	766080e7          	jalr	1894(ra) # 80005cac <mbuffree>
    return -1;
    8000654e:	b7cd                	j	80006530 <sockwrite+0x70>
    return -1;
    80006550:	59fd                	li	s3,-1
    80006552:	bff9                	j	80006530 <sockwrite+0x70>

0000000080006554 <sockrecvudp>:

// called by protocol handler layer to deliver UDP packets
void
sockrecvudp(struct mbuf *m, uint32 raddr, uint16 lport, uint16 rport)
{
    80006554:	7139                	addi	sp,sp,-64
    80006556:	fc06                	sd	ra,56(sp)
    80006558:	f822                	sd	s0,48(sp)
    8000655a:	f426                	sd	s1,40(sp)
    8000655c:	f04a                	sd	s2,32(sp)
    8000655e:	ec4e                	sd	s3,24(sp)
    80006560:	e852                	sd	s4,16(sp)
    80006562:	e456                	sd	s5,8(sp)
    80006564:	0080                	addi	s0,sp,64
    80006566:	8a2a                	mv	s4,a0
    80006568:	892e                	mv	s2,a1
    8000656a:	89b2                	mv	s3,a2
    8000656c:	8ab6                	mv	s5,a3
  ...
  acquire(&lock);
    8000656e:	00019517          	auipc	a0,0x19
    80006572:	db250513          	addi	a0,a0,-590 # 8001f320 <lock>
    80006576:	00001097          	auipc	ra,0x1
    8000657a:	ba0080e7          	jalr	-1120(ra) # 80007116 <acquire>
  si = sockets;
    8000657e:	00004497          	auipc	s1,0x4
    80006582:	aaa4b483          	ld	s1,-1366(s1) # 8000a028 <sockets>
  while (si) {
    80006586:	c4ad                	beqz	s1,800065f0 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    80006588:	0009871b          	sext.w	a4,s3
    8000658c:	000a869b          	sext.w	a3,s5
    80006590:	a019                	j	80006596 <sockrecvudp+0x42>
      goto found;
    si = si->next;
    80006592:	6084                	ld	s1,0(s1)
  while (si) {
    80006594:	ccb1                	beqz	s1,800065f0 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    80006596:	449c                	lw	a5,8(s1)
    80006598:	ff279de3          	bne	a5,s2,80006592 <sockrecvudp+0x3e>
    8000659c:	00c4d783          	lhu	a5,12(s1)
    800065a0:	fee799e3          	bne	a5,a4,80006592 <sockrecvudp+0x3e>
    800065a4:	00e4d783          	lhu	a5,14(s1)
    800065a8:	fed795e3          	bne	a5,a3,80006592 <sockrecvudp+0x3e>
  release(&lock);
  mbuffree(m);
  return;
...
found:
  acquire(&si->lock);
    800065ac:	01048913          	addi	s2,s1,16
    800065b0:	854a                	mv	a0,s2
    800065b2:	00001097          	auipc	ra,0x1
    800065b6:	b64080e7          	jalr	-1180(ra) # 80007116 <acquire>
  mbufq_pushtail(&si->rxq, m);
    800065ba:	02848493          	addi	s1,s1,40
    800065be:	85d2                	mv	a1,s4
    800065c0:	8526                	mv	a0,s1
    800065c2:	fffff097          	auipc	ra,0xfffff
    800065c6:	702080e7          	jalr	1794(ra) # 80005cc4 <mbufq_pushtail>
  wakeup(&si->rxq);
    800065ca:	8526                	mv	a0,s1
    800065cc:	ffffb097          	auipc	ra,0xffffb
    800065d0:	11c080e7          	jalr	284(ra) # 800016e8 <wakeup>
  release(&si->lock);
    800065d4:	854a                	mv	a0,s2
    800065d6:	00001097          	auipc	ra,0x1
    800065da:	bf4080e7          	jalr	-1036(ra) # 800071ca <release>
  release(&lock);
    800065de:	00019517          	auipc	a0,0x19
    800065e2:	d4250513          	addi	a0,a0,-702 # 8001f320 <lock>
    800065e6:	00001097          	auipc	ra,0x1
    800065ea:	be4080e7          	jalr	-1052(ra) # 800071ca <release>
    800065ee:	a831                	j	8000660a <sockrecvudp+0xb6>
  release(&lock);
    800065f0:	00019517          	auipc	a0,0x19
    800065f4:	d3050513          	addi	a0,a0,-720 # 8001f320 <lock>
    800065f8:	00001097          	auipc	ra,0x1
    800065fc:	bd2080e7          	jalr	-1070(ra) # 800071ca <release>
  mbuffree(m);
    80006600:	8552                	mv	a0,s4
    80006602:	fffff097          	auipc	ra,0xfffff
    80006606:	6aa080e7          	jalr	1706(ra) # 80005cac <mbuffree>
}
...
pci_init()
{
    ...
    8000662e:	e45e                	sd	s7,8(sp)
    80006630:	0880                	addi	s0,sp,80
    80006632:	300004b7          	lui	s1,0x30000
    ...
    if(id == 0x100e8086){
    80006636:	100e8937          	lui	s2,0x100e8
    8000663a:	08690913          	addi	s2,s2,134 # 100e8086 <_entry-0x6ff17f7a>
      // command and status register.
      // bit 0 : I/O access enable
      // bit 1 : memory access enable
      // bit 2 : enable mastering
      base[1] = 7;
    8000663e:	4b9d                	li	s7,7
      for(int i = 0; i < 6; i++){
        uint32 old = base[4+i];
    ...
    80006640:	5afd                	li	s5,-1
      ...
      base[4+0] = e1000_regs;
    80006642:	40000b37          	lui	s6,0x40000
    80006646:	6a09                	lui	s4,0x2
  for(int dev = 0; dev < 32; dev++){
    80006648:	300409b7          	lui	s3,0x30040
    8000664c:	a821                	j	80006664 <pci_init+0x48>
      base[4+0] = e1000_regs;
    8000664e:	0166a823          	sw	s6,16(a3)

      e1000_init((uint32*)e1000_regs);
    80006652:	40000537          	lui	a0,0x40000
    80006656:	fffff097          	auipc	ra,0xfffff
    8000665a:	10a080e7          	jalr	266(ra) # 80005760 <e1000_init>
  for(int dev = 0; dev < 32; dev++){
    8000665e:	94d2                	add	s1,s1,s4
    80006660:	03348a63          	beq	s1,s3,80006694 <pci_init+0x78>
    volatile uint32 *base = ecam + off;
    80006664:	86a6                	mv	a3,s1
    uint32 id = base[0];
    80006666:	409c                	lw	a5,0(s1)
    80006668:	2781                	sext.w	a5,a5
    if(id == 0x100e8086){
    8000666a:	ff279ae3          	bne	a5,s2,8000665e <pci_init+0x42>
      base[1] = 7;
    8000666e:	0174a223          	sw	s7,4(s1) # 30000004 <_entry-0x4ffffffc>
      __sync_synchronize();
    80006672:	0ff0000f          	fence
      for(int i = 0; i < 6; i++){
    80006676:	01048793          	addi	a5,s1,16
    8000667a:	02848613          	addi	a2,s1,40
        uint32 old = base[4+i];
    8000667e:	4398                	lw	a4,0(a5)
    80006680:	2701                	sext.w	a4,a4
        base[4+i] = 0xffffffff;
    80006682:	0157a023          	sw	s5,0(a5)
        __sync_synchronize();
    80006686:	0ff0000f          	fence
        base[4+i] = old;
    8000668a:	c398                	sw	a4,0(a5)
      for(int i = 0; i < 6; i++){
    8000668c:	0791                	addi	a5,a5,4
    8000668e:	fec798e3          	bne	a5,a2,8000667e <pci_init+0x62>
    80006692:	bf75                	j	8000664e <pci_init+0x32>
    }
  }
}
...
timerinit()
{
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
    800066b8:	0037979b          	slliw	a5,a5,0x3
    800066bc:	02004737          	lui	a4,0x2004
    800066c0:	97ba                	add	a5,a5,a4
    800066c2:	0200c737          	lui	a4,0x200c
    800066c6:	ff873583          	ld	a1,-8(a4) # 200bff8 <_entry-0x7dff4008>
    800066ca:	000f4637          	lui	a2,0xf4
    800066ce:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
    800066d2:	95b2                	add	a1,a1,a2
    800066d4:	e38c                	sd	a1,0(a5)
  ...
  uint64 *scratch = &timer_scratch[id][0];
    800066d6:	00269713          	slli	a4,a3,0x2
    800066da:	9736                	add	a4,a4,a3
    800066dc:	00371693          	slli	a3,a4,0x3
    800066e0:	00019717          	auipc	a4,0x19
    800066e4:	c6070713          	addi	a4,a4,-928 # 8001f340 <timer_scratch>
    800066e8:	9736                	add	a4,a4,a3
  scratch[3] = CLINT_MTIMECMP(id);
    800066ea:	ef1c                	sd	a5,24(a4)
  scratch[4] = interval;
    800066ec:	f310                	sd	a2,32(a4)
  asm volatile("csrw mscratch, %0" : : "r" (x));
    800066ee:	34071073          	csrw	mscratch,a4
  asm volatile("csrw mtvec, %0" : : "r" (x));
    800066f2:	fffff797          	auipc	a5,0xfffff
    800066f6:	a0e78793          	addi	a5,a5,-1522 # 80005100 <timervec>
    800066fa:	30579073          	csrw	mtvec,a5
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    800066fe:	300027f3          	csrr	a5,mstatus
  ...
  w_mstatus(r_mstatus() | MSTATUS_MIE);
    80006702:	0087e793          	ori	a5,a5,8
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006706:	30079073          	csrw	mstatus,a5
  asm volatile("csrr %0, mie" : "=r" (x) );
    8000670a:	304027f3          	csrr	a5,mie

  // enable machine-mode timer interrupts.
  w_mie(r_mie() | MIE_MTIE);
    8000670e:	0807e793          	ori	a5,a5,128
  asm volatile("csrw mie, %0" : : "r" (x));
    80006712:	30479073          	csrw	mie,a5
}
    80006716:	6422                	ld	s0,8(sp)
    80006718:	0141                	addi	sp,sp,16
    8000671a:	8082                	ret

000000008000671c <start>:
{
    8000671c:	1141                	addi	sp,sp,-16
    8000671e:	e406                	sd	ra,8(sp)
    80006720:	e022                	sd	s0,0(sp)
    80006722:	0800                	addi	s0,sp,16
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    80006724:	300027f3          	csrr	a5,mstatus
  x &= ~MSTATUS_MPP_MASK;
    80006728:	7779                	lui	a4,0xffffe
    8000672a:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffd727f>
    8000672e:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
    80006730:	6705                	lui	a4,0x1
    80006732:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    80006736:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006738:	30079073          	csrw	mstatus,a5
  asm volatile("csrw mepc, %0" : : "r" (x));
    8000673c:	ffffa797          	auipc	a5,0xffffa
    80006740:	bea78793          	addi	a5,a5,-1046 # 80000326 <main>
    80006744:	34179073          	csrw	mepc,a5
  asm volatile("csrw satp, %0" : : "r" (x));
    80006748:	4781                	li	a5,0
    8000674a:	18079073          	csrw	satp,a5
  asm volatile("csrw medeleg, %0" : : "r" (x));
    8000674e:	67c1                	lui	a5,0x10
    80006750:	17fd                	addi	a5,a5,-1
    80006752:	30279073          	csrw	medeleg,a5
  asm volatile("csrw mideleg, %0" : : "r" (x));
    80006756:	30379073          	csrw	mideleg,a5
  asm volatile("csrr %0, sie" : "=r" (x) );
    8000675a:	104027f3          	csrr	a5,sie
  w_sie(r_sie() | SIE_SEIE | SIE_STIE | SIE_SSIE);
    8000675e:	2227e793          	ori	a5,a5,546
  asm volatile("csrw sie, %0" : : "r" (x));
    80006762:	10479073          	csrw	sie,a5
  asm volatile("csrw pmpaddr0, %0" : : "r" (x));
    80006766:	57fd                	li	a5,-1
    80006768:	83a9                	srli	a5,a5,0xa
    8000676a:	3b079073          	csrw	pmpaddr0,a5
  asm volatile("csrw pmpcfg0, %0" : : "r" (x));
    8000676e:	47bd                	li	a5,15
    80006770:	3a079073          	csrw	pmpcfg0,a5
  timerinit();
    80006774:	00000097          	auipc	ra,0x0
    80006778:	f36080e7          	jalr	-202(ra) # 800066aa <timerinit>
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    8000677c:	f14027f3          	csrr	a5,mhartid
  w_tp(id);
    80006780:	2781                	sext.w	a5,a5
  asm volatile("mv tp, %0" : : "r" (x));
    80006782:	823e                	mv	tp,a5
  asm volatile("mret");
    80006784:	30200073          	mret
}
    80006788:	60a2                	ld	ra,8(sp)
    8000678a:	6402                	ld	s0,0(sp)
    8000678c:	0141                	addi	sp,sp,16
    8000678e:	8082                	ret

0000000080006790 <consolewrite>:
//
...
consolewrite(int user_src, uint64 src, int n)
{
    ...
    800067a0:	0880                	addi	s0,sp,80
  int i;

  for(i = 0; i < n; i++){
    800067a2:	04c05663          	blez	a2,800067ee <consolewrite+0x5e>
    800067a6:	8a2a                	mv	s4,a0
    800067a8:	84ae                	mv	s1,a1
    800067aa:	89b2                	mv	s3,a2
    800067ac:	4901                	li	s2,0
    char c;
    if(either_copyin(&c, user_src, src+i, 1) == -1)
    800067ae:	5afd                	li	s5,-1
    800067b0:	4685                	li	a3,1
    800067b2:	8626                	mv	a2,s1
    800067b4:	85d2                	mv	a1,s4
    800067b6:	fbf40513          	addi	a0,s0,-65
    800067ba:	ffffb097          	auipc	ra,0xffffb
    800067be:	19c080e7          	jalr	412(ra) # 80001956 <either_copyin>
    800067c2:	01550c63          	beq	a0,s5,800067da <consolewrite+0x4a>
      break;
    uartputc(c);
    800067c6:	fbf44503          	lbu	a0,-65(s0)
    800067ca:	00000097          	auipc	ra,0x0
    800067ce:	78e080e7          	jalr	1934(ra) # 80006f58 <uartputc>
  for(i = 0; i < n; i++){
    800067d2:	2905                	addiw	s2,s2,1
    800067d4:	0485                	addi	s1,s1,1
    800067d6:	fd299de3          	bne	s3,s2,800067b0 <consolewrite+0x20>
  }

  return i;
}
    800067da:	854a                	mv	a0,s2
    800067dc:	60a6                	ld	ra,72(sp)
    800067de:	6406                	ld	s0,64(sp)
    800067e0:	74e2                	ld	s1,56(sp)
    800067e2:	7942                	ld	s2,48(sp)
    800067e4:	79a2                	ld	s3,40(sp)
    800067e6:	7a02                	ld	s4,32(sp)
    800067e8:	6ae2                	ld	s5,24(sp)
    800067ea:	6161                	addi	sp,sp,80
    800067ec:	8082                	ret
  for(i = 0; i < n; i++){
    800067ee:	4901                	li	s2,0
    800067f0:	b7ed                	j	800067da <consolewrite+0x4a>

00000000800067f2 <consoleread>:
...
{
    800067f2:	7119                	addi	sp,sp,-128
    800067f4:	fc86                	sd	ra,120(sp)
    800067f6:	f8a2                	sd	s0,112(sp)
    800067f8:	f4a6                	sd	s1,104(sp)
    800067fa:	f0ca                	sd	s2,96(sp)
    800067fc:	ecce                	sd	s3,88(sp)
    800067fe:	e8d2                	sd	s4,80(sp)
    80006800:	e4d6                	sd	s5,72(sp)
    80006802:	e0da                	sd	s6,64(sp)
    80006804:	fc5e                	sd	s7,56(sp)
    80006806:	f862                	sd	s8,48(sp)
    80006808:	f466                	sd	s9,40(sp)
    8000680a:	f06a                	sd	s10,32(sp)
    8000680c:	ec6e                	sd	s11,24(sp)
    8000680e:	0100                	addi	s0,sp,128
    80006810:	8b2a                	mv	s6,a0
    80006812:	8aae                	mv	s5,a1
    80006814:	8a32                	mv	s4,a2
  uint target;
  int c;
  char cbuf;

  target = n;
    80006816:	00060b9b          	sext.w	s7,a2
  acquire(&cons.lock);
    8000681a:	00021517          	auipc	a0,0x21
    8000681e:	c6650513          	addi	a0,a0,-922 # 80027480 <cons>
    80006822:	00001097          	auipc	ra,0x1
    80006826:	8f4080e7          	jalr	-1804(ra) # 80007116 <acquire>
  while(n > 0){
    // wait until interrupt handler has put some
    // input into cons.buffer.
    while(cons.r == cons.w){
    8000682a:	00021497          	auipc	s1,0x21
    8000682e:	c5648493          	addi	s1,s1,-938 # 80027480 <cons>
      if(myproc()->killed){
        release(&cons.lock);
        return -1;
      }
    ...
    if(c == '\n'){
    80006840:	4da9                	li	s11,10
  while(n > 0){
    80006842:	07405863          	blez	s4,800068b2 <consoleread+0xc0>
    while(cons.r == cons.w){
    80006846:	0984a783          	lw	a5,152(s1)
    8000684a:	09c4a703          	lw	a4,156(s1)
    8000684e:	02f71463          	bne	a4,a5,80006876 <consoleread+0x84>
      if(myproc()->killed){
    80006852:	ffffa097          	auipc	ra,0xffffa
    80006856:	64e080e7          	jalr	1614(ra) # 80000ea0 <myproc>
    8000685a:	551c                	lw	a5,40(a0)
    8000685c:	e7b5                	bnez	a5,800068c8 <consoleread+0xd6>
      sleep(&cons.r, &cons.lock);
    8000685e:	85ce                	mv	a1,s3
    80006860:	854a                	mv	a0,s2
    80006862:	ffffb097          	auipc	ra,0xffffb
    80006866:	cfa080e7          	jalr	-774(ra) # 8000155c <sleep>
    while(cons.r == cons.w){
    8000686a:	0984a783          	lw	a5,152(s1)
    8000686e:	09c4a703          	lw	a4,156(s1)
    80006872:	fef700e3          	beq	a4,a5,80006852 <consoleread+0x60>
    c = cons.buf[cons.r++ % INPUT_BUF];
    ...
    80006888:	00070c1b          	sext.w	s8,a4
    if(c == C('D')){  // end-of-file
    8000688c:	079c0663          	beq	s8,s9,800068f8 <consoleread+0x106>
    cbuf = c;
    80006890:	f8e407a3          	sb	a4,-113(s0)
    if(either_copyout(user_dst, dst, &cbuf, 1) == -1)
    80006894:	4685                	li	a3,1
    80006896:	f8f40613          	addi	a2,s0,-113
    8000689a:	85d6                	mv	a1,s5
    8000689c:	855a                	mv	a0,s6
    8000689e:	ffffb097          	auipc	ra,0xffffb
    800068a2:	062080e7          	jalr	98(ra) # 80001900 <either_copyout>
    800068a6:	01a50663          	beq	a0,s10,800068b2 <consoleread+0xc0>
    dst++;
    800068aa:	0a85                	addi	s5,s5,1
    --n;
    800068ac:	3a7d                	addiw	s4,s4,-1
    if(c == '\n'){
    800068ae:	f9bc1ae3          	bne	s8,s11,80006842 <consoleread+0x50>
  ...
  release(&cons.lock);
    ...
    800068be:	910080e7          	jalr	-1776(ra) # 800071ca <release>

  return target - n;
    800068c2:	414b853b          	subw	a0,s7,s4
    800068c6:	a811                	j	800068da <consoleread+0xe8>
        release(&cons.lock);
    800068c8:	00021517          	auipc	a0,0x21
    800068cc:	bb850513          	addi	a0,a0,-1096 # 80027480 <cons>
    800068d0:	00001097          	auipc	ra,0x1
    800068d4:	8fa080e7          	jalr	-1798(ra) # 800071ca <release>
        return -1;
    800068d8:	557d                	li	a0,-1
}
    800068da:	70e6                	ld	ra,120(sp)
    800068dc:	7446                	ld	s0,112(sp)
    800068de:	74a6                	ld	s1,104(sp)
    800068e0:	7906                	ld	s2,96(sp)
    800068e2:	69e6                	ld	s3,88(sp)
    800068e4:	6a46                	ld	s4,80(sp)
    800068e6:	6aa6                	ld	s5,72(sp)
    800068e8:	6b06                	ld	s6,64(sp)
    800068ea:	7be2                	ld	s7,56(sp)
    800068ec:	7c42                	ld	s8,48(sp)
    800068ee:	7ca2                	ld	s9,40(sp)
    800068f0:	7d02                	ld	s10,32(sp)
    800068f2:	6de2                	ld	s11,24(sp)
    800068f4:	6109                	addi	sp,sp,128
    800068f6:	8082                	ret
      if(n < target){
    800068f8:	000a071b          	sext.w	a4,s4
    800068fc:	fb777be3          	bgeu	a4,s7,800068b2 <consoleread+0xc0>
        cons.r--;
    80006900:	00021717          	auipc	a4,0x21
    80006904:	c0f72c23          	sw	a5,-1000(a4) # 80027518 <cons+0x98>
    80006908:	b76d                	j	800068b2 <consoleread+0xc0>

000000008000690a <consputc>:
{
  ...
  if(c == BACKSPACE){
    80006912:	10000793          	li	a5,256
    80006916:	00f50a63          	beq	a0,a5,8000692a <consputc+0x20>
    uartputc_sync(c);
    8000691a:	00000097          	auipc	ra,0x0
    8000691e:	564080e7          	jalr	1380(ra) # 80006e7e <uartputc_sync>
}
    80006922:	60a2                	ld	ra,8(sp)
    80006924:	6402                	ld	s0,0(sp)
    80006926:	0141                	addi	sp,sp,16
    80006928:	8082                	ret
    uartputc_sync('\b'); uartputc_sync(' '); uartputc_sync('\b');
    8000692a:	4521                	li	a0,8
    8000692c:	00000097          	auipc	ra,0x0
    80006930:	552080e7          	jalr	1362(ra) # 80006e7e <uartputc_sync>
    80006934:	02000513          	li	a0,32
    80006938:	00000097          	auipc	ra,0x0
    8000693c:	546080e7          	jalr	1350(ra) # 80006e7e <uartputc_sync>
    80006940:	4521                	li	a0,8
    80006942:	00000097          	auipc	ra,0x0
    80006946:	53c080e7          	jalr	1340(ra) # 80006e7e <uartputc_sync>
    8000694a:	bfe1                	j	80006922 <consputc+0x18>

000000008000694c <consoleintr>:
...
consoleintr(int c)
{
    ...
    80006958:	84aa                	mv	s1,a0
  acquire(&cons.lock);
    8000695a:	00021517          	auipc	a0,0x21
    8000695e:	b2650513          	addi	a0,a0,-1242 # 80027480 <cons>
    80006962:	00000097          	auipc	ra,0x0
    80006966:	7b4080e7          	jalr	1972(ra) # 80007116 <acquire>

  switch(c){
    8000696a:	47d5                	li	a5,21
    8000696c:	0af48663          	beq	s1,a5,80006a18 <consoleintr+0xcc>
    80006970:	0297ca63          	blt	a5,s1,800069a4 <consoleintr+0x58>
    80006974:	47a1                	li	a5,8
    80006976:	0ef48763          	beq	s1,a5,80006a64 <consoleintr+0x118>
    8000697a:	47c1                	li	a5,16
    8000697c:	10f49a63          	bne	s1,a5,80006a90 <consoleintr+0x144>
  case C('P'):  // Print process list.
    procdump();
    80006980:	ffffb097          	auipc	ra,0xffffb
    80006984:	02c080e7          	jalr	44(ra) # 800019ac <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    ...
    8000698c:	af850513          	addi	a0,a0,-1288 # 80027480 <cons>
    80006990:	00001097          	auipc	ra,0x1
    80006994:	83a080e7          	jalr	-1990(ra) # 800071ca <release>
}
    80006998:	60e2                	ld	ra,24(sp)
    8000699a:	6442                	ld	s0,16(sp)
    8000699c:	64a2                	ld	s1,8(sp)
    8000699e:	6902                	ld	s2,0(sp)
    800069a0:	6105                	addi	sp,sp,32
    800069a2:	8082                	ret
  switch(c){
    800069a4:	07f00793          	li	a5,127
    800069a8:	0af48e63          	beq	s1,a5,80006a64 <consoleintr+0x118>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    800069ac:	00021717          	auipc	a4,0x21
    800069b0:	ad470713          	addi	a4,a4,-1324 # 80027480 <cons>
    800069b4:	0a072783          	lw	a5,160(a4)
    800069b8:	09872703          	lw	a4,152(a4)
    800069bc:	9f99                	subw	a5,a5,a4
    800069be:	07f00713          	li	a4,127
    800069c2:	fcf763e3          	bltu	a4,a5,80006988 <consoleintr+0x3c>
      c = (c == '\r') ? '\n' : c;
    800069c6:	47b5                	li	a5,13
    800069c8:	0cf48763          	beq	s1,a5,80006a96 <consoleintr+0x14a>
      consputc(c);
    800069cc:	8526                	mv	a0,s1
    800069ce:	00000097          	auipc	ra,0x0
    800069d2:	f3c080e7          	jalr	-196(ra) # 8000690a <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    800069d6:	00021797          	auipc	a5,0x21
    800069da:	aaa78793          	addi	a5,a5,-1366 # 80027480 <cons>
    800069de:	0a07a703          	lw	a4,160(a5)
    800069e2:	0017069b          	addiw	a3,a4,1
    800069e6:	0006861b          	sext.w	a2,a3
    800069ea:	0ad7a023          	sw	a3,160(a5)
    800069ee:	07f77713          	andi	a4,a4,127
    800069f2:	97ba                	add	a5,a5,a4
    800069f4:	00978c23          	sb	s1,24(a5)
      if(c == '\n' || c == C('D') || cons.e == cons.r+INPUT_BUF){
    800069f8:	47a9                	li	a5,10
    800069fa:	0cf48563          	beq	s1,a5,80006ac4 <consoleintr+0x178>
    800069fe:	4791                	li	a5,4
    80006a00:	0cf48263          	beq	s1,a5,80006ac4 <consoleintr+0x178>
    80006a04:	00021797          	auipc	a5,0x21
    80006a08:	b147a783          	lw	a5,-1260(a5) # 80027518 <cons+0x98>
    80006a0c:	0807879b          	addiw	a5,a5,128
    80006a10:	f6f61ce3          	bne	a2,a5,80006988 <consoleintr+0x3c>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a14:	863e                	mv	a2,a5
    80006a16:	a07d                	j	80006ac4 <consoleintr+0x178>
    while(cons.e != cons.w &&
    80006a18:	00021717          	auipc	a4,0x21
    80006a1c:	a6870713          	addi	a4,a4,-1432 # 80027480 <cons>
    80006a20:	0a072783          	lw	a5,160(a4)
    80006a24:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a28:	00021497          	auipc	s1,0x21
    80006a2c:	a5848493          	addi	s1,s1,-1448 # 80027480 <cons>
    while(cons.e != cons.w &&
    80006a30:	4929                	li	s2,10
    80006a32:	f4f70be3          	beq	a4,a5,80006988 <consoleintr+0x3c>
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a36:	37fd                	addiw	a5,a5,-1
    80006a38:	07f7f713          	andi	a4,a5,127
    80006a3c:	9726                	add	a4,a4,s1
    while(cons.e != cons.w &&
    80006a3e:	01874703          	lbu	a4,24(a4)
    80006a42:	f52703e3          	beq	a4,s2,80006988 <consoleintr+0x3c>
      cons.e--;
    80006a46:	0af4a023          	sw	a5,160(s1)
      consputc(BACKSPACE);
    80006a4a:	10000513          	li	a0,256
    80006a4e:	00000097          	auipc	ra,0x0
    80006a52:	ebc080e7          	jalr	-324(ra) # 8000690a <consputc>
    while(cons.e != cons.w &&
    80006a56:	0a04a783          	lw	a5,160(s1)
    80006a5a:	09c4a703          	lw	a4,156(s1)
    80006a5e:	fcf71ce3          	bne	a4,a5,80006a36 <consoleintr+0xea>
    80006a62:	b71d                	j	80006988 <consoleintr+0x3c>
    if(cons.e != cons.w){
    80006a64:	00021717          	auipc	a4,0x21
    80006a68:	a1c70713          	addi	a4,a4,-1508 # 80027480 <cons>
    80006a6c:	0a072783          	lw	a5,160(a4)
    80006a70:	09c72703          	lw	a4,156(a4)
    80006a74:	f0f70ae3          	beq	a4,a5,80006988 <consoleintr+0x3c>
      cons.e--;
    80006a78:	37fd                	addiw	a5,a5,-1
    80006a7a:	00021717          	auipc	a4,0x21
    80006a7e:	aaf72323          	sw	a5,-1370(a4) # 80027520 <cons+0xa0>
      consputc(BACKSPACE);
    80006a82:	10000513          	li	a0,256
    80006a86:	00000097          	auipc	ra,0x0
    80006a8a:	e84080e7          	jalr	-380(ra) # 8000690a <consputc>
    80006a8e:	bded                	j	80006988 <consoleintr+0x3c>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    80006a90:	ee048ce3          	beqz	s1,80006988 <consoleintr+0x3c>
    80006a94:	bf21                	j	800069ac <consoleintr+0x60>
      consputc(c);
    80006a96:	4529                	li	a0,10
    80006a98:	00000097          	auipc	ra,0x0
    80006a9c:	e72080e7          	jalr	-398(ra) # 8000690a <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006aa0:	00021797          	auipc	a5,0x21
    80006aa4:	9e078793          	addi	a5,a5,-1568 # 80027480 <cons>
    80006aa8:	0a07a703          	lw	a4,160(a5)
    80006aac:	0017069b          	addiw	a3,a4,1
    80006ab0:	0006861b          	sext.w	a2,a3
    80006ab4:	0ad7a023          	sw	a3,160(a5)
    80006ab8:	07f77713          	andi	a4,a4,127
    80006abc:	97ba                	add	a5,a5,a4
    80006abe:	4729                	li	a4,10
    80006ac0:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80006ac4:	00021797          	auipc	a5,0x21
    80006ac8:	a4c7ac23          	sw	a2,-1448(a5) # 8002751c <cons+0x9c>
        wakeup(&cons.r);
    80006acc:	00021517          	auipc	a0,0x21
    80006ad0:	a4c50513          	addi	a0,a0,-1460 # 80027518 <cons+0x98>
    80006ad4:	ffffb097          	auipc	ra,0xffffb
    80006ad8:	c14080e7          	jalr	-1004(ra) # 800016e8 <wakeup>
    80006adc:	b575                	j	80006988 <consoleintr+0x3c>

0000000080006ade <consoleinit>:
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80006aea:	d2a58593          	addi	a1,a1,-726 # 80009810 <syscalls+0x438>
    80006aee:	00021517          	auipc	a0,0x21
    80006af2:	99250513          	addi	a0,a0,-1646 # 80027480 <cons>
    80006af6:	00000097          	auipc	ra,0x0
    80006afa:	590080e7          	jalr	1424(ra) # 80007086 <initlock>

  uartinit();
    80006afe:	00000097          	auipc	ra,0x0
    80006b02:	330080e7          	jalr	816(ra) # 80006e2e <uartinit>

  // connect read and write system calls
  // to consoleread and consolewrite.
  devsw[CONSOLE].read = consoleread;
    80006b06:	00013797          	auipc	a5,0x13
    80006b0a:	5e278793          	addi	a5,a5,1506 # 8001a0e8 <devsw>
    80006b0e:	00000717          	auipc	a4,0x0
    80006b12:	ce470713          	addi	a4,a4,-796 # 800067f2 <consoleread>
    80006b16:	eb98                	sd	a4,16(a5)
  devsw[CONSOLE].write = consolewrite;
    80006b18:	00000717          	auipc	a4,0x0
    80006b1c:	c7870713          	addi	a4,a4,-904 # 80006790 <consolewrite>
    80006b20:	ef98                	sd	a4,24(a5)
}
    80006b22:	60a2                	ld	ra,8(sp)
    80006b24:	6402                	ld	s0,0(sp)
    80006b26:	0141                	addi	sp,sp,16
    80006b28:	8082                	ret

0000000080006b2a <printint>:
...
{
    80006b2a:	7179                	addi	sp,sp,-48
    80006b2c:	f406                	sd	ra,40(sp)
    80006b2e:	f022                	sd	s0,32(sp)
    80006b30:	ec26                	sd	s1,24(sp)
    80006b32:	e84a                	sd	s2,16(sp)
    80006b34:	1800                	addi	s0,sp,48
  char buf[16];
  int i;
  uint x;

  if(sign && (sign = xx < 0))
    80006b36:	c219                	beqz	a2,80006b3c <printint+0x12>
    80006b38:	08054663          	bltz	a0,80006bc4 <printint+0x9a>
    x = -xx;
  else
    x = xx;
    80006b3c:	2501                	sext.w	a0,a0
    80006b3e:	4881                	li	a7,0
    80006b40:	fd040693          	addi	a3,s0,-48

  i = 0;
    80006b44:	4701                	li	a4,0
  do {
    buf[i++] = digits[x % base];
    80006b46:	2581                	sext.w	a1,a1
    80006b48:	00003617          	auipc	a2,0x3
    80006b4c:	cf860613          	addi	a2,a2,-776 # 80009840 <digits>
    80006b50:	883a                	mv	a6,a4
    80006b52:	2705                	addiw	a4,a4,1
    80006b54:	02b577bb          	remuw	a5,a0,a1
    80006b58:	1782                	slli	a5,a5,0x20
    80006b5a:	9381                	srli	a5,a5,0x20
    80006b5c:	97b2                	add	a5,a5,a2
    80006b5e:	0007c783          	lbu	a5,0(a5)
    80006b62:	00f68023          	sb	a5,0(a3)
  } while((x /= base) != 0);
    80006b66:	0005079b          	sext.w	a5,a0
    80006b6a:	02b5553b          	divuw	a0,a0,a1
    80006b6e:	0685                	addi	a3,a3,1
    80006b70:	feb7f0e3          	bgeu	a5,a1,80006b50 <printint+0x26>

  if(sign)
    80006b74:	00088b63          	beqz	a7,80006b8a <printint+0x60>
    buf[i++] = '-';
    80006b78:	fe040793          	addi	a5,s0,-32
    80006b7c:	973e                	add	a4,a4,a5
    80006b7e:	02d00793          	li	a5,45
    80006b82:	fef70823          	sb	a5,-16(a4)
    80006b86:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    80006b8a:	02e05763          	blez	a4,80006bb8 <printint+0x8e>
    80006b8e:	fd040793          	addi	a5,s0,-48
    80006b92:	00e784b3          	add	s1,a5,a4
    80006b96:	fff78913          	addi	s2,a5,-1
    80006b9a:	993a                	add	s2,s2,a4
    80006b9c:	377d                	addiw	a4,a4,-1
    80006b9e:	1702                	slli	a4,a4,0x20
    80006ba0:	9301                	srli	a4,a4,0x20
    80006ba2:	40e90933          	sub	s2,s2,a4
    consputc(buf[i]);
    80006ba6:	fff4c503          	lbu	a0,-1(s1)
    80006baa:	00000097          	auipc	ra,0x0
    80006bae:	d60080e7          	jalr	-672(ra) # 8000690a <consputc>
  while(--i >= 0)
    80006bb2:	14fd                	addi	s1,s1,-1
    80006bb4:	ff2499e3          	bne	s1,s2,80006ba6 <printint+0x7c>
}
    80006bb8:	70a2                	ld	ra,40(sp)
    80006bba:	7402                	ld	s0,32(sp)
    80006bbc:	64e2                	ld	s1,24(sp)
    80006bbe:	6942                	ld	s2,16(sp)
    80006bc0:	6145                	addi	sp,sp,48
    80006bc2:	8082                	ret
    x = -xx;
    80006bc4:	40a0053b          	negw	a0,a0
  if(sign && (sign = xx < 0))
    80006bc8:	4885                	li	a7,1
    x = -xx;
    80006bca:	bf9d                	j	80006b40 <printint+0x16>

0000000080006bcc <panic>:
    release(&pr.lock);
}
...
panic(char *s)
{
    ...
    80006bd4:	1000                	addi	s0,sp,32
    80006bd6:	84aa                	mv	s1,a0
  pr.locking = 0;
    80006bd8:	00021797          	auipc	a5,0x21
    80006bdc:	9607a423          	sw	zero,-1688(a5) # 80027540 <pr+0x18>
  printf("panic: ");
    80006be0:	00003517          	auipc	a0,0x3
    80006be4:	c3850513          	addi	a0,a0,-968 # 80009818 <syscalls+0x440>
    80006be8:	00000097          	auipc	ra,0x0
    80006bec:	02e080e7          	jalr	46(ra) # 80006c16 <printf>
  printf(s);
    80006bf0:	8526                	mv	a0,s1
    80006bf2:	00000097          	auipc	ra,0x0
    80006bf6:	024080e7          	jalr	36(ra) # 80006c16 <printf>
  printf("\n");
    80006bfa:	00002517          	auipc	a0,0x2
    80006bfe:	44e50513          	addi	a0,a0,1102 # 80009048 <etext+0x48>
    80006c02:	00000097          	auipc	ra,0x0
    80006c06:	014080e7          	jalr	20(ra) # 80006c16 <printf>
  panicked = 1; // freeze uart output from other CPUs
    80006c0a:	4785                	li	a5,1
    80006c0c:	00003717          	auipc	a4,0x3
    80006c10:	42f72223          	sw	a5,1060(a4) # 8000a030 <panicked>
  for(;;)
    80006c14:	a001                	j	80006c14 <panic+0x48>

0000000080006c16 <printf>:
{
    80006c16:	7131                	addi	sp,sp,-192
    80006c18:	fc86                	sd	ra,120(sp)
    80006c1a:	f8a2                	sd	s0,112(sp)
    80006c1c:	f4a6                	sd	s1,104(sp)
    80006c1e:	f0ca                	sd	s2,96(sp)
    80006c20:	ecce                	sd	s3,88(sp)
    80006c22:	e8d2                	sd	s4,80(sp)
    80006c24:	e4d6                	sd	s5,72(sp)
    80006c26:	e0da                	sd	s6,64(sp)
    80006c28:	fc5e                	sd	s7,56(sp)
    80006c2a:	f862                	sd	s8,48(sp)
    80006c2c:	f466                	sd	s9,40(sp)
    80006c2e:	f06a                	sd	s10,32(sp)
    80006c30:	ec6e                	sd	s11,24(sp)
    80006c32:	0100                	addi	s0,sp,128
    80006c34:	8a2a                	mv	s4,a0
    80006c36:	e40c                	sd	a1,8(s0)
    80006c38:	e810                	sd	a2,16(s0)
    80006c3a:	ec14                	sd	a3,24(s0)
    80006c3c:	f018                	sd	a4,32(s0)
    80006c3e:	f41c                	sd	a5,40(s0)
    80006c40:	03043823          	sd	a6,48(s0)
    80006c44:	03143c23          	sd	a7,56(s0)
  locking = pr.locking;
    80006c48:	00021d97          	auipc	s11,0x21
    80006c4c:	8f8dad83          	lw	s11,-1800(s11) # 80027540 <pr+0x18>
  if(locking)
    80006c50:	020d9b63          	bnez	s11,80006c86 <printf+0x70>
  if (fmt == 0)
    80006c54:	040a0263          	beqz	s4,80006c98 <printf+0x82>
  va_start(ap, fmt);
    80006c58:	00840793          	addi	a5,s0,8
    80006c5c:	f8f43423          	sd	a5,-120(s0)
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006c60:	000a4503          	lbu	a0,0(s4) # 2000 <_entry-0x7fffe000>
    80006c64:	16050263          	beqz	a0,80006dc8 <printf+0x1b2>
    80006c68:	4481                	li	s1,0
    if(c != '%'){
    80006c6a:	02500a93          	li	s5,37
    switch(c){
    80006c6e:	07000b13          	li	s6,112
  consputc('x');
    80006c72:	4d41                	li	s10,16
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006c74:	00003b97          	auipc	s7,0x3
    80006c78:	bccb8b93          	addi	s7,s7,-1076 # 80009840 <digits>
    switch(c){
    80006c7c:	07300c93          	li	s9,115
    80006c80:	06400c13          	li	s8,100
    80006c84:	a82d                	j	80006cbe <printf+0xa8>
    acquire(&pr.lock);
    80006c86:	00021517          	auipc	a0,0x21
    80006c8a:	8a250513          	addi	a0,a0,-1886 # 80027528 <pr>
    80006c8e:	00000097          	auipc	ra,0x0
    80006c92:	488080e7          	jalr	1160(ra) # 80007116 <acquire>
    80006c96:	bf7d                	j	80006c54 <printf+0x3e>
    panic("null fmt");
    80006c98:	00003517          	auipc	a0,0x3
    80006c9c:	b9050513          	addi	a0,a0,-1136 # 80009828 <syscalls+0x450>
    80006ca0:	00000097          	auipc	ra,0x0
    80006ca4:	f2c080e7          	jalr	-212(ra) # 80006bcc <panic>
      consputc(c);
    80006ca8:	00000097          	auipc	ra,0x0
    80006cac:	c62080e7          	jalr	-926(ra) # 8000690a <consputc>
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006cb0:	2485                	addiw	s1,s1,1
    80006cb2:	009a07b3          	add	a5,s4,s1
    80006cb6:	0007c503          	lbu	a0,0(a5)
    80006cba:	10050763          	beqz	a0,80006dc8 <printf+0x1b2>
    if(c != '%'){
    80006cbe:	ff5515e3          	bne	a0,s5,80006ca8 <printf+0x92>
    c = fmt[++i] & 0xff;
    80006cc2:	2485                	addiw	s1,s1,1
    80006cc4:	009a07b3          	add	a5,s4,s1
    80006cc8:	0007c783          	lbu	a5,0(a5)
    80006ccc:	0007891b          	sext.w	s2,a5
    if(c == 0)
    80006cd0:	cfe5                	beqz	a5,80006dc8 <printf+0x1b2>
    switch(c){
    80006cd2:	05678a63          	beq	a5,s6,80006d26 <printf+0x110>
    80006cd6:	02fb7663          	bgeu	s6,a5,80006d02 <printf+0xec>
    80006cda:	09978963          	beq	a5,s9,80006d6c <printf+0x156>
    80006cde:	07800713          	li	a4,120
    80006ce2:	0ce79863          	bne	a5,a4,80006db2 <printf+0x19c>
      printint(va_arg(ap, int), 16, 1);
    80006ce6:	f8843783          	ld	a5,-120(s0)
    80006cea:	00878713          	addi	a4,a5,8
    80006cee:	f8e43423          	sd	a4,-120(s0)
    80006cf2:	4605                	li	a2,1
    80006cf4:	85ea                	mv	a1,s10
    80006cf6:	4388                	lw	a0,0(a5)
    80006cf8:	00000097          	auipc	ra,0x0
    80006cfc:	e32080e7          	jalr	-462(ra) # 80006b2a <printint>
      break;
    80006d00:	bf45                	j	80006cb0 <printf+0x9a>
    switch(c){
    80006d02:	0b578263          	beq	a5,s5,80006da6 <printf+0x190>
    80006d06:	0b879663          	bne	a5,s8,80006db2 <printf+0x19c>
      printint(va_arg(ap, int), 10, 1);
    80006d0a:	f8843783          	ld	a5,-120(s0)
    80006d0e:	00878713          	addi	a4,a5,8
    80006d12:	f8e43423          	sd	a4,-120(s0)
    80006d16:	4605                	li	a2,1
    80006d18:	45a9                	li	a1,10
    80006d1a:	4388                	lw	a0,0(a5)
    80006d1c:	00000097          	auipc	ra,0x0
    80006d20:	e0e080e7          	jalr	-498(ra) # 80006b2a <printint>
      break;
    80006d24:	b771                	j	80006cb0 <printf+0x9a>
      printptr(va_arg(ap, uint64));
    80006d26:	f8843783          	ld	a5,-120(s0)
    80006d2a:	00878713          	addi	a4,a5,8
    80006d2e:	f8e43423          	sd	a4,-120(s0)
    80006d32:	0007b983          	ld	s3,0(a5)
  consputc('0');
    80006d36:	03000513          	li	a0,48
    80006d3a:	00000097          	auipc	ra,0x0
    80006d3e:	bd0080e7          	jalr	-1072(ra) # 8000690a <consputc>
  consputc('x');
    80006d42:	07800513          	li	a0,120
    80006d46:	00000097          	auipc	ra,0x0
    80006d4a:	bc4080e7          	jalr	-1084(ra) # 8000690a <consputc>
    80006d4e:	896a                	mv	s2,s10
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006d50:	03c9d793          	srli	a5,s3,0x3c
    80006d54:	97de                	add	a5,a5,s7
    80006d56:	0007c503          	lbu	a0,0(a5)
    80006d5a:	00000097          	auipc	ra,0x0
    80006d5e:	bb0080e7          	jalr	-1104(ra) # 8000690a <consputc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    80006d62:	0992                	slli	s3,s3,0x4
    80006d64:	397d                	addiw	s2,s2,-1
    80006d66:	fe0915e3          	bnez	s2,80006d50 <printf+0x13a>
    80006d6a:	b799                	j	80006cb0 <printf+0x9a>
      if((s = va_arg(ap, char*)) == 0)
    80006d6c:	f8843783          	ld	a5,-120(s0)
    80006d70:	00878713          	addi	a4,a5,8
    80006d74:	f8e43423          	sd	a4,-120(s0)
    80006d78:	0007b903          	ld	s2,0(a5)
    80006d7c:	00090e63          	beqz	s2,80006d98 <printf+0x182>
      for(; *s; s++)
    80006d80:	00094503          	lbu	a0,0(s2)
    80006d84:	d515                	beqz	a0,80006cb0 <printf+0x9a>
        consputc(*s);
    80006d86:	00000097          	auipc	ra,0x0
    80006d8a:	b84080e7          	jalr	-1148(ra) # 8000690a <consputc>
      for(; *s; s++)
    80006d8e:	0905                	addi	s2,s2,1
    80006d90:	00094503          	lbu	a0,0(s2)
    80006d94:	f96d                	bnez	a0,80006d86 <printf+0x170>
    80006d96:	bf29                	j	80006cb0 <printf+0x9a>
        s = "(null)";
    80006d98:	00003917          	auipc	s2,0x3
    80006d9c:	a8890913          	addi	s2,s2,-1400 # 80009820 <syscalls+0x448>
      for(; *s; s++)
    80006da0:	02800513          	li	a0,40
    80006da4:	b7cd                	j	80006d86 <printf+0x170>
      consputc('%');
    80006da6:	8556                	mv	a0,s5
    80006da8:	00000097          	auipc	ra,0x0
    80006dac:	b62080e7          	jalr	-1182(ra) # 8000690a <consputc>
      break;
    80006db0:	b701                	j	80006cb0 <printf+0x9a>
      consputc('%');
    80006db2:	8556                	mv	a0,s5
    80006db4:	00000097          	auipc	ra,0x0
    80006db8:	b56080e7          	jalr	-1194(ra) # 8000690a <consputc>
      consputc(c);
    80006dbc:	854a                	mv	a0,s2
    80006dbe:	00000097          	auipc	ra,0x0
    80006dc2:	b4c080e7          	jalr	-1204(ra) # 8000690a <consputc>
      break;
    80006dc6:	b5ed                	j	80006cb0 <printf+0x9a>
  if(locking)
    80006dc8:	020d9163          	bnez	s11,80006dea <printf+0x1d4>
}
    80006dcc:	70e6                	ld	ra,120(sp)
    80006dce:	7446                	ld	s0,112(sp)
    80006dd0:	74a6                	ld	s1,104(sp)
    80006dd2:	7906                	ld	s2,96(sp)
    80006dd4:	69e6                	ld	s3,88(sp)
    80006dd6:	6a46                	ld	s4,80(sp)
    80006dd8:	6aa6                	ld	s5,72(sp)
    80006dda:	6b06                	ld	s6,64(sp)
    80006ddc:	7be2                	ld	s7,56(sp)
    80006dde:	7c42                	ld	s8,48(sp)
    80006de0:	7ca2                	ld	s9,40(sp)
    80006de2:	7d02                	ld	s10,32(sp)
    80006de4:	6de2                	ld	s11,24(sp)
    80006de6:	6129                	addi	sp,sp,192
    80006de8:	8082                	ret
    release(&pr.lock);
    80006dea:	00020517          	auipc	a0,0x20
    80006dee:	73e50513          	addi	a0,a0,1854 # 80027528 <pr>
    80006df2:	00000097          	auipc	ra,0x0
    80006df6:	3d8080e7          	jalr	984(ra) # 800071ca <release>
}
    80006dfa:	bfc9                	j	80006dcc <printf+0x1b6>

0000000080006dfc <printfinit>:
    ;
}
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    80006e06:	00020497          	auipc	s1,0x20
    80006e0a:	72248493          	addi	s1,s1,1826 # 80027528 <pr>
    80006e0e:	00003597          	auipc	a1,0x3
    80006e12:	a2a58593          	addi	a1,a1,-1494 # 80009838 <syscalls+0x460>
    80006e16:	8526                	mv	a0,s1
    80006e18:	00000097          	auipc	ra,0x0
    80006e1c:	26e080e7          	jalr	622(ra) # 80007086 <initlock>
  pr.locking = 1;
    80006e20:	4785                	li	a5,1
    80006e22:	cc9c                	sw	a5,24(s1)
}
...
uartinit(void)
{
    ...
    80006e30:	e406                	sd	ra,8(sp)
    80006e32:	e022                	sd	s0,0(sp)
    80006e34:	0800                	addi	s0,sp,16
  // disable interrupts.
  WriteReg(IER, 0x00);
    80006e36:	100007b7          	lui	a5,0x10000
    80006e3a:	000780a3          	sb	zero,1(a5) # 10000001 <_entry-0x6fffffff>

  // special mode to set baud rate.
  WriteReg(LCR, LCR_BAUD_LATCH);
    80006e3e:	f8000713          	li	a4,-128
    80006e42:	00e781a3          	sb	a4,3(a5)

  // LSB for baud rate of 38.4K.
  WriteReg(0, 0x03);
    80006e46:	470d                	li	a4,3
    80006e48:	00e78023          	sb	a4,0(a5)

  // MSB for baud rate of 38.4K.
  WriteReg(1, 0x00);
    80006e4c:	000780a3          	sb	zero,1(a5)

  // leave set-baud mode,
  // and set word length to 8 bits, no parity.
  WriteReg(LCR, LCR_EIGHT_BITS);
    80006e50:	00e781a3          	sb	a4,3(a5)

  // reset and enable FIFOs.
  WriteReg(FCR, FCR_FIFO_ENABLE | FCR_FIFO_CLEAR);
    80006e54:	469d                	li	a3,7
    80006e56:	00d78123          	sb	a3,2(a5)

  // enable transmit and receive interrupts.
  WriteReg(IER, IER_TX_ENABLE | IER_RX_ENABLE);
    80006e5a:	00e780a3          	sb	a4,1(a5)

  initlock(&uart_tx_lock, "uart");
    80006e5e:	00003597          	auipc	a1,0x3
    80006e62:	9fa58593          	addi	a1,a1,-1542 # 80009858 <digits+0x18>
    80006e66:	00020517          	auipc	a0,0x20
    80006e6a:	6e250513          	addi	a0,a0,1762 # 80027548 <uart_tx_lock>
    80006e6e:	00000097          	auipc	ra,0x0
    80006e72:	218080e7          	jalr	536(ra) # 80007086 <initlock>
}
    80006e76:	60a2                	ld	ra,8(sp)
    80006e78:	6402                	ld	s0,0(sp)
    80006e7a:	0141                	addi	sp,sp,16
    80006e7c:	8082                	ret

0000000080006e7e <uartputc_sync>:
...
uartputc_sync(int c)
{
    ...
    80006e88:	84aa                	mv	s1,a0
  push_off();
    80006e8a:	00000097          	auipc	ra,0x0
    80006e8e:	240080e7          	jalr	576(ra) # 800070ca <push_off>

  if(panicked){
    80006e92:	00003797          	auipc	a5,0x3
    80006e96:	19e7a783          	lw	a5,414(a5) # 8000a030 <panicked>
    for(;;)
      ;
  }
  ...
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006e9a:	10000737          	lui	a4,0x10000
  if(panicked){
    80006e9e:	c391                	beqz	a5,80006ea2 <uartputc_sync+0x24>
    for(;;)
    80006ea0:	a001                	j	80006ea0 <uartputc_sync+0x22>
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006ea2:	00574783          	lbu	a5,5(a4) # 10000005 <_entry-0x6ffffffb>
    80006ea6:	0ff7f793          	andi	a5,a5,255
    80006eaa:	0207f793          	andi	a5,a5,32
    80006eae:	dbf5                	beqz	a5,80006ea2 <uartputc_sync+0x24>
    ;
  WriteReg(THR, c);
    80006eb0:	0ff4f793          	andi	a5,s1,255
    80006eb4:	10000737          	lui	a4,0x10000
    80006eb8:	00f70023          	sb	a5,0(a4) # 10000000 <_entry-0x70000000>

  pop_off();
    80006ebc:	00000097          	auipc	ra,0x0
    80006ec0:	2ae080e7          	jalr	686(ra) # 8000716a <pop_off>
}
    80006ec4:	60e2                	ld	ra,24(sp)
    80006ec6:	6442                	ld	s0,16(sp)
    80006ec8:	64a2                	ld	s1,8(sp)
    80006eca:	6105                	addi	sp,sp,32
    80006ecc:	8082                	ret

0000000080006ece <uartstart>:
...
uartstart()
{
  while(1){
    ...
    80006ece:	00003717          	auipc	a4,0x3
    80006ed2:	16a73703          	ld	a4,362(a4) # 8000a038 <uart_tx_r>
    80006ed6:	00003797          	auipc	a5,0x3
    80006eda:	16a7b783          	ld	a5,362(a5) # 8000a040 <uart_tx_w>
    80006ede:	06e78c63          	beq	a5,a4,80006f56 <uartstart+0x88>
{
    80006ee2:	7139                	addi	sp,sp,-64
    80006ee4:	fc06                	sd	ra,56(sp)
    80006ee6:	f822                	sd	s0,48(sp)
    80006ee8:	f426                	sd	s1,40(sp)
    80006eea:	f04a                	sd	s2,32(sp)
    80006eec:	ec4e                	sd	s3,24(sp)
    80006eee:	e852                	sd	s4,16(sp)
    80006ef0:	e456                	sd	s5,8(sp)
    80006ef2:	0080                	addi	s0,sp,64
      // transmit buffer is empty.
      return;
    }
    
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006ef4:	10000937          	lui	s2,0x10000
    ...
    80006ef8:	00020a17          	auipc	s4,0x20
    80006efc:	650a0a13          	addi	s4,s4,1616 # 80027548 <uart_tx_lock>
    uart_tx_r += 1;
    80006f00:	00003497          	auipc	s1,0x3
    80006f04:	13848493          	addi	s1,s1,312 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80006f08:	00003997          	auipc	s3,0x3
    80006f0c:	13898993          	addi	s3,s3,312 # 8000a040 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f10:	00594783          	lbu	a5,5(s2) # 10000005 <_entry-0x6ffffffb>
    80006f14:	0ff7f793          	andi	a5,a5,255
    80006f18:	0207f793          	andi	a5,a5,32
    80006f1c:	c785                	beqz	a5,80006f44 <uartstart+0x76>
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    80006f1e:	01f77793          	andi	a5,a4,31
    80006f22:	97d2                	add	a5,a5,s4
    80006f24:	0187ca83          	lbu	s5,24(a5)
    uart_tx_r += 1;
    80006f28:	0705                	addi	a4,a4,1
    80006f2a:	e098                	sd	a4,0(s1)
    
    // maybe uartputc() is waiting for space in the buffer.
    wakeup(&uart_tx_r);
    80006f2c:	8526                	mv	a0,s1
    80006f2e:	ffffa097          	auipc	ra,0xffffa
    80006f32:	7ba080e7          	jalr	1978(ra) # 800016e8 <wakeup>
    
    WriteReg(THR, c);
    80006f36:	01590023          	sb	s5,0(s2)
    if(uart_tx_w == uart_tx_r){
    80006f3a:	6098                	ld	a4,0(s1)
    80006f3c:	0009b783          	ld	a5,0(s3)
    80006f40:	fce798e3          	bne	a5,a4,80006f10 <uartstart+0x42>
  }
}
...
0000000080006f58 <uartputc>:
{
    ...
    80006f68:	89aa                	mv	s3,a0
  acquire(&uart_tx_lock);
    80006f6a:	00020517          	auipc	a0,0x20
    80006f6e:	5de50513          	addi	a0,a0,1502 # 80027548 <uart_tx_lock>
    80006f72:	00000097          	auipc	ra,0x0
    80006f76:	1a4080e7          	jalr	420(ra) # 80007116 <acquire>
  if(panicked){
    80006f7a:	00003797          	auipc	a5,0x3
    80006f7e:	0b67a783          	lw	a5,182(a5) # 8000a030 <panicked>
    80006f82:	c391                	beqz	a5,80006f86 <uartputc+0x2e>
    for(;;)
    80006f84:	a001                	j	80006f84 <uartputc+0x2c>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006f86:	00003797          	auipc	a5,0x3
    80006f8a:	0ba7b783          	ld	a5,186(a5) # 8000a040 <uart_tx_w>
    80006f8e:	00003717          	auipc	a4,0x3
    80006f92:	0aa73703          	ld	a4,170(a4) # 8000a038 <uart_tx_r>
    80006f96:	02070713          	addi	a4,a4,32
    80006f9a:	02f71b63          	bne	a4,a5,80006fd0 <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006f9e:	00020a17          	auipc	s4,0x20
    80006fa2:	5aaa0a13          	addi	s4,s4,1450 # 80027548 <uart_tx_lock>
    80006fa6:	00003497          	auipc	s1,0x3
    80006faa:	09248493          	addi	s1,s1,146 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fae:	00003917          	auipc	s2,0x3
    80006fb2:	09290913          	addi	s2,s2,146 # 8000a040 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006fb6:	85d2                	mv	a1,s4
    80006fb8:	8526                	mv	a0,s1
    80006fba:	ffffa097          	auipc	ra,0xffffa
    80006fbe:	5a2080e7          	jalr	1442(ra) # 8000155c <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fc2:	00093783          	ld	a5,0(s2)
    80006fc6:	6098                	ld	a4,0(s1)
    80006fc8:	02070713          	addi	a4,a4,32
    80006fcc:	fef705e3          	beq	a4,a5,80006fb6 <uartputc+0x5e>
      uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    80006fd0:	00020497          	auipc	s1,0x20
    80006fd4:	57848493          	addi	s1,s1,1400 # 80027548 <uart_tx_lock>
    80006fd8:	01f7f713          	andi	a4,a5,31
    80006fdc:	9726                	add	a4,a4,s1
    80006fde:	01370c23          	sb	s3,24(a4)
      uart_tx_w += 1;
    80006fe2:	0785                	addi	a5,a5,1
    80006fe4:	00003717          	auipc	a4,0x3
    80006fe8:	04f73e23          	sd	a5,92(a4) # 8000a040 <uart_tx_w>
      uartstart();
    80006fec:	00000097          	auipc	ra,0x0
    80006ff0:	ee2080e7          	jalr	-286(ra) # 80006ece <uartstart>
      release(&uart_tx_lock);
    80006ff4:	8526                	mv	a0,s1
    80006ff6:	00000097          	auipc	ra,0x0
    80006ffa:	1d4080e7          	jalr	468(ra) # 800071ca <release>
}
    80006ffe:	70a2                	ld	ra,40(sp)
    80007000:	7402                	ld	s0,32(sp)
    80007002:	64e2                	ld	s1,24(sp)
    80007004:	6942                	ld	s2,16(sp)
    80007006:	69a2                	ld	s3,8(sp)
    80007008:	6a02                	ld	s4,0(sp)
    8000700a:	6145                	addi	sp,sp,48
    8000700c:	8082                	ret
...
uartgetc(void)
{
  ...
  if(ReadReg(LSR) & 0x01){
    ...
    8000701e:	cb91                	beqz	a5,80007032 <uartgetc+0x24>
    // input data is ready.
    return ReadReg(RHR);
    ...
    8000702c:	6422                	ld	s0,8(sp)
    8000702e:	0141                	addi	sp,sp,16
    80007030:	8082                	ret
    return -1;
    80007032:	557d                	li	a0,-1
    80007034:	bfe5                	j	8000702c <uartgetc+0x1e>

0000000080007036 <uartintr>:
...
uartintr(void)
{
  ...
  while(1){
    int c = uartgetc();
    if(c == -1)
    80007040:	54fd                	li	s1,-1
    int c = uartgetc();
    80007042:	00000097          	auipc	ra,0x0
    80007046:	fcc080e7          	jalr	-52(ra) # 8000700e <uartgetc>
    if(c == -1)
    8000704a:	00950763          	beq	a0,s1,80007058 <uartintr+0x22>
      break;
    consoleintr(c);
    8000704e:	00000097          	auipc	ra,0x0
    80007052:	8fe080e7          	jalr	-1794(ra) # 8000694c <consoleintr>
  while(1){
    80007056:	b7f5                	j	80007042 <uartintr+0xc>
  }

  // send buffered characters.
  acquire(&uart_tx_lock);
    80007058:	00020497          	auipc	s1,0x20
    8000705c:	4f048493          	addi	s1,s1,1264 # 80027548 <uart_tx_lock>
    80007060:	8526                	mv	a0,s1
    80007062:	00000097          	auipc	ra,0x0
    80007066:	0b4080e7          	jalr	180(ra) # 80007116 <acquire>
  uartstart();
    8000706a:	00000097          	auipc	ra,0x0
    8000706e:	e64080e7          	jalr	-412(ra) # 80006ece <uartstart>
  release(&uart_tx_lock);
    80007072:	8526                	mv	a0,s1
    80007074:	00000097          	auipc	ra,0x0
    80007078:	156080e7          	jalr	342(ra) # 800071ca <release>
}
...
{
    80007086:	1141                	addi	sp,sp,-16
    80007088:	e422                	sd	s0,8(sp)
    8000708a:	0800                	addi	s0,sp,16
  lk->name = name;
    8000708c:	e50c                	sd	a1,8(a0)
  lk->locked = 0;
    8000708e:	00052023          	sw	zero,0(a0)
  lk->cpu = 0;
    80007092:	00053823          	sd	zero,16(a0)
#ifdef LAB_LOCK
  lk->nts = 0;
  lk->n = 0;
  findslot(lk);
    ...
    80007096:	6422                	ld	s0,8(sp)
    80007098:	0141                	addi	sp,sp,16
    8000709a:	8082                	ret

000000008000709c <holding>:
...
holding(struct spinlock *lk)
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    8000709c:	411c                	lw	a5,0(a0)
    8000709e:	e399                	bnez	a5,800070a4 <holding+0x8>
    800070a0:	4501                	li	a0,0
  return r;
}
    800070a2:	8082                	ret
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    800070ae:	6904                	ld	s1,16(a0)
    800070b0:	ffffa097          	auipc	ra,0xffffa
    800070b4:	dd4080e7          	jalr	-556(ra) # 80000e84 <mycpu>
    800070b8:	40a48533          	sub	a0,s1,a0
    800070bc:	00153513          	seqz	a0,a0
}
...
push_off(void)
{
    800070ca:	1101                	addi	sp,sp,-32
    800070cc:	ec06                	sd	ra,24(sp)
    800070ce:	e822                	sd	s0,16(sp)
    800070d0:	e426                	sd	s1,8(sp)
    800070d2:	1000                	addi	s0,sp,32
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800070d4:	100024f3          	csrr	s1,sstatus
    800070d8:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    800070dc:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
    800070de:	10079073          	csrw	sstatus,a5
  int old = intr_get();

  intr_off();
  if(mycpu()->noff == 0)
    800070e2:	ffffa097          	auipc	ra,0xffffa
    800070e6:	da2080e7          	jalr	-606(ra) # 80000e84 <mycpu>
    800070ea:	5d3c                	lw	a5,120(a0)
    800070ec:	cf89                	beqz	a5,80007106 <push_off+0x3c>
    mycpu()->intena = old;
  mycpu()->noff += 1;
    800070ee:	ffffa097          	auipc	ra,0xffffa
    800070f2:	d96080e7          	jalr	-618(ra) # 80000e84 <mycpu>
    800070f6:	5d3c                	lw	a5,120(a0)
    800070f8:	2785                	addiw	a5,a5,1
    800070fa:	dd3c                	sw	a5,120(a0)
}
    800070fc:	60e2                	ld	ra,24(sp)
    800070fe:	6442                	ld	s0,16(sp)
    80007100:	64a2                	ld	s1,8(sp)
    80007102:	6105                	addi	sp,sp,32
    80007104:	8082                	ret
    mycpu()->intena = old;
    80007106:	ffffa097          	auipc	ra,0xffffa
    8000710a:	d7e080e7          	jalr	-642(ra) # 80000e84 <mycpu>
  return (x & SSTATUS_SIE) != 0;
    8000710e:	8085                	srli	s1,s1,0x1
    80007110:	8885                	andi	s1,s1,1
    80007112:	dd64                	sw	s1,124(a0)
    80007114:	bfe9                	j	800070ee <push_off+0x24>

0000000080007116 <acquire>:
{
    80007116:	1101                	addi	sp,sp,-32
    80007118:	ec06                	sd	ra,24(sp)
    8000711a:	e822                	sd	s0,16(sp)
    8000711c:	e426                	sd	s1,8(sp)
    8000711e:	1000                	addi	s0,sp,32
    80007120:	84aa                	mv	s1,a0
  push_off(); // disable interrupts to avoid deadlock.
    80007122:	00000097          	auipc	ra,0x0
    80007126:	fa8080e7          	jalr	-88(ra) # 800070ca <push_off>
  if(holding(lk))
    8000712a:	8526                	mv	a0,s1
    8000712c:	00000097          	auipc	ra,0x0
    80007130:	f70080e7          	jalr	-144(ra) # 8000709c <holding>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    80007134:	4705                	li	a4,1
  if(holding(lk))
    80007136:	e115                	bnez	a0,8000715a <acquire+0x44>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    80007138:	87ba                	mv	a5,a4
    8000713a:	0cf4a7af          	amoswap.w.aq	a5,a5,(s1)
    8000713e:	2781                	sext.w	a5,a5
    80007140:	ffe5                	bnez	a5,80007138 <acquire+0x22>
  __sync_synchronize();
    80007142:	0ff0000f          	fence
  lk->cpu = mycpu();
    80007146:	ffffa097          	auipc	ra,0xffffa
    8000714a:	d3e080e7          	jalr	-706(ra) # 80000e84 <mycpu>
    8000714e:	e888                	sd	a0,16(s1)
}
    80007150:	60e2                	ld	ra,24(sp)
    80007152:	6442                	ld	s0,16(sp)
    80007154:	64a2                	ld	s1,8(sp)
    80007156:	6105                	addi	sp,sp,32
    80007158:	8082                	ret
    panic("acquire");
    8000715a:	00002517          	auipc	a0,0x2
    8000715e:	70650513          	addi	a0,a0,1798 # 80009860 <digits+0x20>
    80007162:	00000097          	auipc	ra,0x0
    80007166:	a6a080e7          	jalr	-1430(ra) # 80006bcc <panic>

000000008000716a <pop_off>:

void
pop_off(void)
{
    8000716a:	1141                	addi	sp,sp,-16
    8000716c:	e406                	sd	ra,8(sp)
    8000716e:	e022                	sd	s0,0(sp)
    80007170:	0800                	addi	s0,sp,16
  struct cpu *c = mycpu();
    80007172:	ffffa097          	auipc	ra,0xffffa
    80007176:	d12080e7          	jalr	-750(ra) # 80000e84 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    8000717a:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    8000717e:	8b89                	andi	a5,a5,2
  if(intr_get())
    80007180:	e78d                	bnez	a5,800071aa <pop_off+0x40>
    panic("pop_off - interruptible");
  if(c->noff < 1)
    80007182:	5d3c                	lw	a5,120(a0)
    80007184:	02f05b63          	blez	a5,800071ba <pop_off+0x50>
    panic("pop_off");
  c->noff -= 1;
    80007188:	37fd                	addiw	a5,a5,-1
    8000718a:	0007871b          	sext.w	a4,a5
    8000718e:	dd3c                	sw	a5,120(a0)
  if(c->noff == 0 && c->intena)
    80007190:	eb09                	bnez	a4,800071a2 <pop_off+0x38>
    80007192:	5d7c                	lw	a5,124(a0)
    80007194:	c799                	beqz	a5,800071a2 <pop_off+0x38>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80007196:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    8000719a:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    8000719e:	10079073          	csrw	sstatus,a5
    intr_on();
}
    ...
    800071ae:	6be50513          	addi	a0,a0,1726 # 80009868 <digits+0x28>
    800071b2:	00000097          	auipc	ra,0x0
    800071b6:	a1a080e7          	jalr	-1510(ra) # 80006bcc <panic>
    panic("pop_off");
    800071ba:	00002517          	auipc	a0,0x2
    800071be:	6c650513          	addi	a0,a0,1734 # 80009880 <digits+0x40>
    800071c2:	00000097          	auipc	ra,0x0
    800071c6:	a0a080e7          	jalr	-1526(ra) # 80006bcc <panic>

00000000800071ca <release>:
{
    800071ca:	1101                	addi	sp,sp,-32
    800071cc:	ec06                	sd	ra,24(sp)
    800071ce:	e822                	sd	s0,16(sp)
    800071d0:	e426                	sd	s1,8(sp)
    800071d2:	1000                	addi	s0,sp,32
    800071d4:	84aa                	mv	s1,a0
  if(!holding(lk))
    800071d6:	00000097          	auipc	ra,0x0
    800071da:	ec6080e7          	jalr	-314(ra) # 8000709c <holding>
    800071de:	c115                	beqz	a0,80007202 <release+0x38>
  lk->cpu = 0;
    800071e0:	0004b823          	sd	zero,16(s1)
  __sync_synchronize();
    800071e4:	0ff0000f          	fence
  __sync_lock_release(&lk->locked);
    800071e8:	0f50000f          	fence	iorw,ow
    800071ec:	0804a02f          	amoswap.w	zero,zero,(s1)
  pop_off();
    800071f0:	00000097          	auipc	ra,0x0
    800071f4:	f7a080e7          	jalr	-134(ra) # 8000716a <pop_off>
}
    800071f8:	60e2                	ld	ra,24(sp)
    800071fa:	6442                	ld	s0,16(sp)
    800071fc:	64a2                	ld	s1,8(sp)
    800071fe:	6105                	addi	sp,sp,32
    80007200:	8082                	ret
    panic("release");
    80007202:	00002517          	auipc	a0,0x2
    80007206:	68650513          	addi	a0,a0,1670 # 80009888 <digits+0x48>
    8000720a:	00000097          	auipc	ra,0x0
    8000720e:	9c2080e7          	jalr	-1598(ra) # 80006bcc <panic>

0000000080007212 <lockfree_read8>:
...
0000000080007228 <lockfree_read4>:

// Read a shared 32-bit value without holding a lock
int
lockfree_read4(int *addr) {
    80007228:	1141                	addi	sp,sp,-16
    8000722a:	e422                	sd	s0,8(sp)
    8000722c:	0800                	addi	s0,sp,16
  uint32 val;
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    8000722e:	0ff0000f          	fence
    80007232:	4108                	lw	a0,0(a0)
    80007234:	0ff0000f          	fence
  return val;
}
    80007238:	2501                	sext.w	a0,a0
