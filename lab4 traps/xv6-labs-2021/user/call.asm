...
void main(void) {  
  ...
  48:	65b9                	lui	a1,0xe
  4a:	11058593          	addi	a1,a1,272 # e110 <__global_pointer$+0xd0af>
  4e:	00000517          	auipc	a0,0x0
  52:	7da50513          	addi	a0,a0,2010 # 828 <malloc+0xf2>
  56:	00000097          	auipc	ra,0x0
  5a:	622080e7          	jalr	1570(ra) # 678 <printf>
  //补充2
  printf("x=%d y=%d", 3);
  5e:	458d                	li	a1,3
  60:	00000517          	auipc	a0,0x0
  64:	7d850513          	addi	a0,a0,2008 # 838 <malloc+0x102>
  68:	00000097          	auipc	ra,0x0
  6c:	610080e7          	jalr	1552(ra) # 678 <printf>
  exit(0);
  70:	4501                	li	a0,0
...
strcpy(char *s, const char *t)
{
  ...
  8a:	fee78fa3          	sb	a4,-1(a5) # 646fff <__global_pointer$+0x645f9e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e8:	46c50513          	addi	a0,a0,1132 # 850 <digits>
 3ec:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b4:	3a0b8b93          	addi	s7,s7,928 # 850 <digits>
 ...
 5f4:	25890913          	addi	s2,s2,600 # 848 <malloc+0x112>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6bc:	1b07b783          	ld	a5,432(a5) # 868 <freep>
 ...
 6ea:	00e6ea63          	bltu	a3,a4,6fe <free+0x50>
{
 ...
 72c:	14f73023          	sd	a5,320(a4) # 868 <freep>
}
 730:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 75e:	10e53503          	ld	a0,270(a0) # 868 <freep>
 ...
 786:	0e690913          	addi	s2,s2,230 # 868 <freep>
  if(p == (char*)-1)
 78a:	5afd                	li	s5,-1
 ...
 79a:	0cf73923          	sd	a5,210(a4) # 868 <freep>
 79e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7c0:	0aa73623          	sd	a0,172(a4) # 868 <freep>
      return (void*)(p + 1);
