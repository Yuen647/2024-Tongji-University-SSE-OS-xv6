...
void primeFilter(int readDescriptor){
  ...
  1a:	3f4080e7          	jalr	1012(ra) # 40a <read>
    printf("prime %d\n", primeNumber);
  1e:	fcc42583          	lw	a1,-52(s0)
  22:	00001517          	auipc	a0,0x1
  26:	8ee50513          	addi	a0,a0,-1810 # 910 <malloc+0xe8>
  2a:	00000097          	auipc	ra,0x0
  2e:	740080e7          	jalr	1856(ra) # 76a <printf>
...
void primeFilter(int readDescriptor){
  ...
  36:	a891                	j	8a <primeFilter+0x8a>
        if(isPipeCreated == 0){
            pipe(pipeDescriptors);  // 创建新的管道
  38:	fc040513          	addi	a0,s0,-64
  3c:	00000097          	auipc	ra,0x0
  40:	3c6080e7          	jalr	966(ra) # 402 <pipe>
            isPipeCreated = 1;
            int pid = fork();
  44:	00000097          	auipc	ra,0x0
  48:	3a6080e7          	jalr	934(ra) # 3ea <fork>
            if(pid == 0){
  4c:	c901                	beqz	a0,5c <primeFilter+0x5c>
  ...
  56:	3c8080e7          	jalr	968(ra) # 41a <close>
  5a:	a091                	j	9e <primeFilter+0x9e>
                close(pipeDescriptors[1]);  // 关闭写端
  5c:	fc442503          	lw	a0,-60(s0)
  60:	00000097          	auipc	ra,0x0
  64:	3ba080e7          	jalr	954(ra) # 41a <close>
                primeFilter(pipeDescriptors[0]);  // 递归调用
  68:	fc042503          	lw	a0,-64(s0)
  6c:	00000097          	auipc	ra,0x0
  70:	f94080e7          	jalr	-108(ra) # 0 <primeFilter>
                return;
  74:	a8a9                	j	ce <primeFilter+0xce>
            }
        }
  ...
  84:	392080e7          	jalr	914(ra) # 412 <write>
void primeFilter(int readDescriptor){
  88:	84ce                	mv	s1,s3
    while(read(readDescriptor, &currentNumber, sizeof(currentNumber)) != 0){
  8a:	4611                	li	a2,4
  ...
  96:	378080e7          	jalr	888(ra) # 40a <read>
  9a:	c911                	beqz	a0,ae <primeFilter+0xae>
        if(isPipeCreated == 0){
  9c:	dcd1                	beqz	s1,38 <primeFilter+0x38>
        if(currentNumber % primeNumber != 0){
  9e:	fbc42783          	lw	a5,-68(s0)
  a2:	fcc42703          	lw	a4,-52(s0)
  a6:	02e7e7bb          	remw	a5,a5,a4
  aa:	dff9                	beqz	a5,88 <primeFilter+0x88>
  ac:	b7e9                	j	76 <primeFilter+0x76>
        }
    }
  ...
  b4:	36a080e7          	jalr	874(ra) # 41a <close>
    close(pipeDescriptors[1]);  // 关闭写端
  b8:	fc442503          	lw	a0,-60(s0)
  bc:	00000097          	auipc	ra,0x0
  c0:	35e080e7          	jalr	862(ra) # 41a <close>
    wait(0);  // 等待子进程结束
  c4:	4501                	li	a0,0
  c6:	00000097          	auipc	ra,0x0
  ca:	334080e7          	jalr	820(ra) # 3fa <wait>
}
  ce:	60a6                	ld	ra,72(sp)
  d0:	6406                	ld	s0,64(sp)
  d2:	74e2                	ld	s1,56(sp)
...
main(int argc, char *argv[]){
  ...
  ee:	318080e7          	jalr	792(ra) # 402 <pipe>

    int pid = fork();
  f2:	00000097          	auipc	ra,0x0
  f6:	2f8080e7          	jalr	760(ra) # 3ea <fork>
    if(pid != 0){
  fa:	cd31                	beqz	a0,156 <main+0x7a>
        // 父进程
        close(initialPipe[0]);  // 关闭读端
  fc:	fd842503          	lw	a0,-40(s0)
 100:	00000097          	auipc	ra,0x0
 104:	31a080e7          	jalr	794(ra) # 41a <close>
        for(int i = 2; i <= 35; i++){
 108:	4789                	li	a5,2
 10a:	fcf42a23          	sw	a5,-44(s0)
 10e:	02300493          	li	s1,35
            write(initialPipe[1], &i, sizeof(i));  // 写入数值
 112:	4611                	li	a2,4
 114:	fd440593          	addi	a1,s0,-44
 118:	fdc42503          	lw	a0,-36(s0)
 11c:	00000097          	auipc	ra,0x0
 120:	2f6080e7          	jalr	758(ra) # 412 <write>
        for(int i = 2; i <= 35; i++){
 124:	fd442783          	lw	a5,-44(s0)
 128:	2785                	addiw	a5,a5,1
 12a:	0007871b          	sext.w	a4,a5
 12e:	fcf42a23          	sw	a5,-44(s0)
 132:	fee4d0e3          	bge	s1,a4,112 <main+0x36>
        }
        close(initialPipe[1]);  // 关闭写端
 136:	fdc42503          	lw	a0,-36(s0)
 13a:	00000097          	auipc	ra,0x0
 13e:	2e0080e7          	jalr	736(ra) # 41a <close>
        wait(0);  // 等待子进程结束
 142:	4501                	li	a0,0
 144:	00000097          	auipc	ra,0x0
 148:	2b6080e7          	jalr	694(ra) # 3fa <wait>
        close(initialPipe[1]);  // 关闭写端
 ...
 152:	2a4080e7          	jalr	676(ra) # 3f2 <exit>
        close(initialPipe[1]);  // 关闭写端
 156:	fdc42503          	lw	a0,-36(s0)
 15a:	00000097          	auipc	ra,0x0
 15e:	2c0080e7          	jalr	704(ra) # 41a <close>
        primeFilter(initialPipe[0]);  // 调用过滤函数
 162:	fd842503          	lw	a0,-40(s0)
 166:	00000097          	auipc	ra,0x0
 16a:	e9a080e7          	jalr	-358(ra) # 0 <primeFilter>
        close(initialPipe[0]);  // 关闭读端
 16e:	fd842503          	lw	a0,-40(s0)
 172:	00000097          	auipc	ra,0x0
 176:	2a8080e7          	jalr	680(ra) # 41a <close>
 17a:	bfc9                	j	14c <main+0x70>
